page 50471 "Delivery to Customers Archive"
{
    // version HEI.06
    ...
    //   #sync with original page P50444
    ...
    // HEI.06 CHG2167931 IBM SISUM01 19/11/2022 #add new fields. The ones marked with description HEI.13 in T50208

    Caption = 'Delivery to Customers Archive';
    Editable = false;
    PageType = List;
    ...
    //             {
    //                 ToolTip = 'Navigate to the Posted Document Shipping Costs page.';
    //                 TableRelation = "Posted Document Shipping Costs" where("Source No." = FIELD("Source Document"));
    //             }
    //         }
    //     }
    // }
