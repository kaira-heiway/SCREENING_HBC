report 50015 "Check Base"
{
    // version HEI.03

    // HEI.01 FDD-PTPGAP024 - Local Dependency IBM.NAIKH01 31.07.2017
    //   # Created a new Report reploica of report 1407 (Check).
    //   # Added fields before from "Company Information" and "Bank Account" table.
    //   # Added The Fields on the Report Design Header.
    // 
    // HEI.02 Defect 874
    //   # Created a new function "SetReqPageFilter"
    // 
    // HEI.03 FDD CHG2037399 IBM NANDIS01 17.03.2020 - Cheque Printing
    ...
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Check Base.rdl';
    ApplicationArea = all;
    Caption = 'Check';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    //HEI.01 NAIKH01
                    Name := BankAcc2.Name;
                    Address := BankAcc2.Address;
                    BankBranchNo := BankAcc2."Bank Branch No.";
                    BankAccountNo := BankAcc2."Bank Account No.";
                    CurrencyCode := BankAcc2."Currency Code";
                    IBAN := BankAcc2.IBAN;
                    SwiftCode := BankAcc2."SWIFT Code";
                    //HEI.01 NAIKH01
    ...
    begin
        ...
        if Req_BankAcc <> '' then begin
            BankAcc2.GET(Req_BankAcc);
    ...
    procedure SetReqPageFilter(BankAccNo: Code[30]);
    begin
        //>>HEI.02
        Req_BankAcc := BankAccNo;
