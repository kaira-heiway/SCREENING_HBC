tableextension 50209 DetailedVendorLedgEntryExtFND extends "Detailed Vendor Ledg. Entry"
{
    ...
    //   DITW17.10.03 MSF 29/03/2014 DIT-715 #670 :Performance problem on Applying entries is back (was solved by Ludo van den Ende)
    //                                            Added Key "Vendor Ledger Entry No.,Entry Type"
    //   DITW18.00.06 DDR 13/07/2015 DIT-770 #1258 Modified keys (sumindexes)
    //                                                 "Entry No."
    //                                               "Document No.,Vendor No."
    //                                             Added key
    ...
    //   DITW18.00.06 MVN 13/10/2015 DIT-770 #1653 Added 4 DRINK-IT Fields to Key 7: used for Flowfields in Table 23
    //                                               DIT Sub-Contract Type,Service Contract No.,Item Charge Type,Vendor Posting Group

    //   DITW110.00.08 DDR 02/01/2017 NRQ#0 UPGRADE NAV 2017 CU1
    //   HEI.01 FDD-KDD0TC002 IBM HORTOC01 04.10.2017 - new option on "Document type" field - "Interest Rate Credit"
    //   BC Upgrade KUMARS145 Enum is already created for "Document type" GenJournalDocTypeEnumExt
    //  DITW15.00.00.37 DDR 01/06/2010 issue 857 Added fields + all keys
    //                                              2034850 DIT Sub-Contract Type
    //                                              2034872 Contract Group Code
    //                                            Added TableRelation for field2034872
    ...
    //   BC Upgrade KUMARS145 Table Ext Created.
    ...
    fields
    {
        ...
        {
            CaptionML = ENU = 'Applied Vend. Ledger Entry No.', FRA = 'N° écriture comptable fourn. lettrée';
        }
        modify(Unapplied)
        {
        ...
        //                                                                            "DIT Sub-Contract Type" = FIELD("DIT Sub-Contract Type"));
        // }
        // field(2034916; "Vendor Posting Group"; Code[10])
        // {
    ...
    keys
    {
        ...
        //Unsupported feature: PropertyChange on ""Vendor Ledger Entry No.","Posting Date"(Key)". Please convert manually.
        ...
        key(Key50000; "Vendor Ledger Entry No.", "Entry Type") //BC Upgrade KUMARS145
        {
            SumIndexFields = Amount, "Amount (LCY)", "Debit Amount", "Credit Amount", "Debit Amount (LCY)", "Credit Amount (LCY)";
        }
        // BC Upgrade KUMARS145 Dependent on Drinkit Fields .....>>
        // key(Key50001; "Vendor Ledger Entry No.", "Entry Type", "Posting Date", "Item Charge Type", "DIT Sub-Contract Type", "Service Contract No.", "Vendor Posting Group")
        // {
        //     MaintainSQLIndex = false;
        //     SumIndexFields = "Amount (LCY)";
        // }
        // key(Key50002; "Vendor No.", "Currency Code", "Initial Entry Global Dim. 1", "Initial Entry Global Dim. 2", "Initial Entry Due Date", "Posting Date", "DIT Sub-Contract Type", "Service Contract No.", "Item Charge Type", "Vendor Posting Group")
        // {
        //     SumIndexFields = Amount, "Amount (LCY)";
        // }
        // BC Upgrade KUMARS145 Dependent on Drinkit Fields ......<<
        key(Key50001; "Document No.", "Vendor No.") // BC Upgrade KUMARS145
        {
