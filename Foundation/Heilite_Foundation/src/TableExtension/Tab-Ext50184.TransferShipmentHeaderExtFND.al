tableextension 50184 TransferShipmentHeaderExtFND extends "Transfer Shipment Header"
{
    ...
    // HEI.02 FDD-HT658 IBM.GUNERE01 29.10.2019 # Document Shipping Costs field added
    // HEI.03 FDD-HT1304 IBM NASTAA02 01.07.2020 # IC Transfer Order Automation
    //   # New Field created : 50005 - IC Document
    //   # Code added on function "CopyFromTransferHeader"
    // HEI.04 FDD-HB1438 CHG2065311 IBM SHANKJ03 30.07.2020
    ...
    // HEI.06 CHG2200434 IBM COSTES04 19.05.2023 Column Data Availability of WH Shipment & WH Receipt No
    //   # New fields added  Posted Whse. Shipment No.
    // HEI.07 CHG2216722 IBM SISUM01 03.10.2023  Request for email functionality for Transfer Order Creation
    //   # New fields Id 50021
    // HEI.08 CHG2260099 COSTES04 26.11.2024 Automatic Archiving of Gate Entry Outbound While Undoing Sales Shipment.
    //   # New field added Gate Entry Archived
    //BC Upgrade SHARMP16 ---tag HEI.03 in Nav Code added in Cu Cod53499.HeinekenBCUpgrade--OnAfterCopyFromTransferHeaderShipment
    //BC Upgrade SHARMP16-- Interface related fields commented and shifted to Int Ext
    ...
    fields
    {
        ...
        field(50021; "Email Sent-Ship FND"; Boolean)
        {
            Caption = 'Email Sent-Ship';
            DataClassification = ToBeClassified;
            Description = 'HEI.07';
            Editable = false;
        }
        field(50022; "Gate Entry Archived FND"; Boolean)
        {
        ...
        // {
        //     CalcFormula = Exist("Posted Document Shipping Cost" where("Source Type" = CONST(5744),
        //                                                                "Source No." = FIELD("No.")));
        ...
        // {
        //     CalcFormula = Sum("Transfer Shipment Line".Weight where("Document No." = FIELD("No.")));
        ...
        // {
        //     CalcFormula = Sum("Transfer Shipment Line".Cubage where("Document No." = FIELD("No.")));
        ...
        // {
        //     CalcFormula = Exist("EMCS Comment Line" where("Table ID" = CONST(5744),
    ...
    */
    ...
    EmcsCommentLine.SETRANGE("Table ID",DATABASE::"Transfer Shipment Header");
