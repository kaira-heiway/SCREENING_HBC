tableextension 50015 PurchInvLineExtFND extends "Purch. Inv. Line"
{
    ...
    // HEI.03 FDD-PURGAPINT002 IBM LAZARE02 25.09.2017
    //   # New fields "Maximo Requisition No.", "Maximo Requisition Line No."
    // HEI.04 DefectID 818 IBM.CHAUHB01 14.12.2017
    //  # Added new flow field "Machine Reference No."
    // HEI.05 FDDPTPGAP011 IBM HORTOC01  31.01.2018
    //  #new field added "Manual Insert"
    // HEI.06 BA-RTRGAP01 IBM NASTAA02 16.08.2018 # Bahamas VAT
    //   # New Field created: 50042 - "TIN No."
    ...
    //                                                                             Minimum Quantity
    // HEI.07 CHG2090912 HB1641 IBM NANDIS01 01.02.2021 General Ledger Entries Description
    //   # Added a new field 50046 - "Additional Description"
    ...
    // HEI.09 FDD-HB2482 CHG2123206 IBM NANDIS01 03.11.2021 - Improvement of multiple HeiLite reports for StP  Procurement users
    //   # Added new field - 50053 - Purchase Order No. - Code - 20
    // HEI.10 CHG2155847 HB2821 IBM NANDIS01 08.09.2022 - DispatchSync and DispatchReceiveReport_Astro WMS Integration
    //   # New field "Astro Unique ID" (ID - 50054) added
    // HEI.11 CHG2217161 SAHAL01 02.11.2023 SPL for Returns and GR cancellations
    //   # Created New Fields: 50057 - SPL Code
    //                         50058 - SPL Name
    //                         50059 - Consumption SPL Code

    // HEI.12 CHG2224401 HB3624 YADAVM09 06.02.2024 Health and Security Levy Tax
    //   # Ned Field Created #H&S Levy Tax %
    //                       #H&S Levy Tax Amount
    //                       #Total Amount Excl VAT/H&S
    ...
    // HEI.14 CHG2224401 HB3624 YADAVM09 01.04.2024 Health and Security Levy Tax
    //   # Ned Field Created #50065 HS Posting Group
    ...
    // HEI.16 CHG2210794 SAHAL01 10.05.2024 Zycus - BASE HL Integration with Transaction GR
    //   # Created New Field: 50085 - Zycus Movement Type
    // HEI.17 CHG2221624 HB3614 IBM SRIVAS07 11.06.2024 # Block Payment for Invoices with Price Difference higher than the tolerance
    //   # Created New Fields: 50081 - Tolerance Exceeded
    ...
    fields
    {
        ...
        //BC UPGRADE SHARMP16 COMMENTED FILEDS NA>>
        ...
        {
            CalcFormula = Lookup("Purch. Inv. Header"."SRM Contract Type FND" where("No." = FIELD("Document No.")));
        ...
        {
            CalcFormula = Lookup("Purch. Inv. Header"."Valid From FND" where("No." = FIELD("Document No.")));
            Caption = 'Valid From';
            Description = 'HEI.01';
            Editable = false;
            FieldClass = FlowField;
        ...
        {
            CalcFormula = Lookup("Purch. Inv. Header"."Valid To FND" where("No." = FIELD("Document No.")));
            Caption = 'Valid To';
            Description = 'HEI.01';
            Editable = false;
            FieldClass = FlowField;
        ...
        field(50053; "Purchase Order No. FND"; Code[20])
        {
            DataClassification = ToBeClassified;
            Description = 'HEI.09';
        ...
        //     Description = 'DITW15.00.00.01-.31';
        ...
        // {
        //     CalcFormula = Exist("Purch. Inv. Line" WHERE ("Document No."=FIELD("Document No."),
