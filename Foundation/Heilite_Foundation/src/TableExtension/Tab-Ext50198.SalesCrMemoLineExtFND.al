tableextension 50198 SalesCrMemoLineExtFND extends "Sales Cr.Memo Line"
{
    // version NAVW110.0.00.16585,FINXL10.00,DITW110.00.11,HEI.01
    ...
    // DITW19.00.07 MVN 30/12/2015 DIT-770 #001 Upgrade: Set Global GetReturnRcptLines
    ...
    // FINXL9.00 RGO 27/06/2016 : Removed local property from GetReturnRcptLines
    ...
    // HEI.06 FDD-SR_HT543a-KSTORE EXPORT IBM HORTOC01 #new flowfield "SalesPerson Code"
    ...
    // HEI.08 FDD-HB1111 IBM NASTAA02 28.02.2020 # Adding Fields to existing Tables - Sales Reports enhancements
    //   # New Fields created: 50020- Shipping Agent Code
    //                         50021- Shipping Agent Service Code
    ...
    // HEI.09 FDD-HT2159 - CHG2105031 IBM NASTAA02 09.06.2021 # Centime - additional tax on VAT
    //   # New Field created 50024 - CAD Amount
    // HEI.10 CHG2109621 HT2170 IBM GAVANM01 10.06.2021 - Posting Setup for Sales Tax (Timbre), transport, free products
    ...
    fields
    {
        ...
        field(50001; "WHT Bus. Posting GrpCstm FND"; Code[10])
        {
            Caption = 'WHT Business Posting GroupCustom';
            Description = 'HEI.01';
            TableRelation = "WHT Business Posting Group FND".Code;
        }
        field(50002; "WHT Prdt Posting GroupCstm FND"; Code[10])
        {
            Caption = 'WHT Product Posting GroupCustom';
            Description = 'HEI.01';
        ...
        field(50011; "Transporter RPMDamage/Loss FND"; Boolean)
        {
        ...
        // {
        //     CalcFormula = Lookup("EBM Log"."Maraki Fiscal No." where("Document Type" = FILTER("Credit Memo"),
        ...
        // }
        //BC Upgrade SHUKLP03 << interface table is used in CalcFormula so need to move in interface extesnion
        field(50020; "Shipping Agent Code FND"; Code[10])
        {
        ...
        field(50021; "Shipping Agent Service Cod FND"; Code[10])
        {
            AccessByPermission = TableData "Shipping Agent Services" = R;
        ...
        //     Description = 'DITW17.10.03 DIT-770 623';
        ...
        // {
        //     CalcFormula = Exist("Sales Cr.Memo Line" where("Document No." = FIELD("Document No."),
    ...
    keys
    {
        ...
        //Unsupported feature: PropertyChange on ""Blanket Order No.","Blanket Order Line No."(Key)". Please convert manually.
