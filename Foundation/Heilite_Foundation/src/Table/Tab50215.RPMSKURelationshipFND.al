table 50215 "RPM - SKU Relationship FND"
{
    // version HEI.07
    ...
    //   #LookupPageID and DrillDownPageID properties updated
    //   #Secondary key added for all the flowfields created to T50208
    // HEI.05 CHG2169207 IBM SISUM01 23/08/2022#new fields added marked with HEI.05
    // HEI.06 CHG2152809 IBM SISUM01 26/08/2022#Add "Own fleet" field to PrimaryKey
    // HEI.07 CHG2167931 IBM SISUM01 19/11/2022 #add new fields with description HEI.07

    Caption = 'RPM - SKU Relationship';
    DrillDownPageID = "RPM - SKU Relationships";
    LookupPageID = "RPM - SKU Relationships";
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."Primary Allocated Amount" where("Period Date" = FIELD("Period Date"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."Net Weight (Kg)" where("Period Date" = FIELD("Period Date"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."General Overheads" where("Destination Type" = CONST(Customer),
                                                                                    "Source Document" = CONST("Sales Return Order"),
                                                                                    "Only RPM Transportation" = CONST(true),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."Warehouse Overheads" where("Destination Type" = CONST(Customer),
                                                                                      "Source Document" = CONST("Sales Return Order"),
                                                                                      "Only RPM Transportation" = CONST(true),
                                                                                      "Period Date" = FIELD("Period Date"),
                                                                                      "Item No." = FIELD("RPM Item No."),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."Warehouse Handling" where("Destination Type" = CONST(Customer),
                                                                                     "Source Document" = CONST("Sales Return Order"),
                                                                                     "Only RPM Transportation" = CONST(true),
                                                                                     "Period Date" = FIELD("Period Date"),
                                                                                     "Item No." = FIELD("RPM Item No."),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."Picking Factor" where("Period Date" = FIELD("Period Date"),
                                                                                 "Only RPM Transportation" = CONST(false),
                                                                                 "Destination Type" = CONST(Customer),
                                                                                 "Destination No." = FIELD("Customer No."),
                                                                                 "Item No." = FIELD("Linked Item No."),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."General Overheads" where("Period Date" = FIELD("Period Date"),
                                                                                    "Destination Type" = CONST(Location),
                                                                                    "Only RPM Transportation" = CONST(true),
                                                                                    "Item No." = FIELD("RPM Item No."),
                                                                                    "Own Fleet" = FIELD("Own Fleet"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."Warehouse Overheads" where("Period Date" = FIELD("Period Date"),
                                                                                      "Destination Type" = CONST(Location),
                                                                                      "Only RPM Transportation" = CONST(true),
                                                                                      "Item No." = FIELD("RPM Item No."),
                                                                                      "Own Fleet" = FIELD("Own Fleet"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."Warehouse Handling" where("Period Date" = FIELD("Period Date"),
                                                                                     "Destination Type" = CONST(Location),
                                                                                     "Only RPM Transportation" = CONST(true),
                                                                                     "Item No." = FIELD("RPM Item No."),
                                                                                     "Own Fleet" = FIELD("Own Fleet"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."OVE Warehouse Handling" where("Destination Type" = CONST(Customer),
                                                                                         "Source Document" = CONST("Sales Return Order"),
                                                                                         "Only RPM Transportation" = CONST(true),
                                                                                         "Period Date" = FIELD("Period Date"),
                                                                                         "Item No." = FIELD("RPM Item No."),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."TRP Warehouse Handling" where("Destination Type" = CONST(Customer),
                                                                                         "Source Document" = CONST("Sales Return Order"),
                                                                                         "Only RPM Transportation" = CONST(true),
                                                                                         "Period Date" = FIELD("Period Date"),
                                                                                         "Item No." = FIELD("RPM Item No."),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."FIX Warehouse Handling" where("Destination Type" = CONST(Customer),
                                                                                         "Source Document" = CONST("Sales Return Order"),
                                                                                         "Only RPM Transportation" = CONST(true),
                                                                                         "Period Date" = FIELD("Period Date"),
                                                                                         "Item No." = FIELD("RPM Item No."),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."OVE Warehouse Handling" where("Period Date" = FIELD("Period Date"),
                                                                                         "Destination Type" = CONST(Location),
                                                                                         "Only RPM Transportation" = CONST(true),
                                                                                         "Item No." = FIELD("RPM Item No."),
                                                                                         "Own Fleet" = FIELD("Own Fleet"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."TRP Warehouse Handling" where("Period Date" = FIELD("Period Date"),
                                                                                         "Destination Type" = CONST(Location),
                                                                                         "Only RPM Transportation" = CONST(true),
                                                                                         "Item No." = FIELD("RPM Item No."),
                                                                                         "Own Fleet" = FIELD("Own Fleet"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Allocation FND"."FIX Warehouse Handling" where("Period Date" = FIELD("Period Date"),
                                                                                         "Destination Type" = CONST(Location),
                                                                                         "Only RPM Transportation" = CONST(true),
                                                                                         "Item No." = FIELD("RPM Item No."),
                                                                                         "Own Fleet" = FIELD("Own Fleet"),
    ...
    keys
    {
        key(Key1; "Period Start Date", "Period End Date", "RPM Item No.", "Linked Item No.", "Customer No.", "Own Fleet")
        {
        }
        key(Key2; "Period Date", "RPM Item No.", "Customer No.", "Own Fleet")
        {
        }
        key(Key3; "Period Start Date", "RPM Item No.")
        {
        }
    }
