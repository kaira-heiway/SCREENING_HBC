...
table 50352 "Inv Posting Bffr HeiliteFA FND"
{
    //BC UPgrade SHARMP16 CU 90
    //-------------------------------BC UPgrade SHARMP16 CU 90----------------------------------
    //Created New Table for FA posting cases in Purchase..
    Caption = 'Invoice Posting Buffer Heilite FA';
    ReplicateData = false;
    ...
    fields
    {
        ...
        field(50000; "WHT Business Posting Group"; Code[10])
        {
        ...
        field(50002; "Purchase Receipt Line No."; Integer)
        {
            Caption = 'Purchase Receipt Line No.';
            Description = 'HEI.02';
        }
        field(50003; "Purchase Receipt Amount"; Decimal)
        {
            Description = 'HEI.02';
        }
        field(50004; "Purchase Receipt No."; Code[20])
        {
            Caption = 'Purchase Receipt No.';
            Description = 'HEI.02';
        }
        field(50008; "Real VAT Amount"; Decimal)
        {
        }
        field(50009; "Additional Description"; Text[100])
        {
        ...
        field(50010; "CAD Amount"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(50011; "Purchase Receipt Unit Cost"; Decimal)
        {
            DataClassification = ToBeClassified;
            Description = 'HEI.05';
        }
        field(50062; "H&S Levy Tax %"; Decimal)
        {
            DataClassification = ToBeClassified;
            Description = 'HEI.06';
            TableRelation = "H&S Tax Posting Group FND";
        }
        field(50063; "H&S Levy Tax Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
            Description = 'HEI.06';
        }
        field(50064; "HS Posting Group"; Code[10])
        {
            DataClassification = ToBeClassified;
            Description = 'HEI.06';
            TableRelation = "H&S Tax Posting Group FND";
        }
        field(50201; "FA Invoice No."; Code[20])
        {
            DataClassification = ToBeClassified;
        }
    }
