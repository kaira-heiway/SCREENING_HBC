table 50143 "Purch. Cr. Memo Hdr. Add FND"
{
    // version NRQ157810,HEI.14

    // HEI.01 FDD-PURGAP027 IBM NASTAA02 11.06.2019 # Maximo POs Approval Flow
    //   # New Table created to extend Standard Table 124 - Purch. Cr. Memo Hdr.
    ...
    // HEI.03 FDD-HT2159 - CHG2105031 IBM NASTAA02 04.08.2021 # VAT Centime - Part 2 - Purchases
    ...
    //                         50086 - Processed GR Transaction Zycus
    // BC Upgrade SHUKLP03 << Added in interface ext.
    Caption = 'Purch. Cr. Memo Hdr. Additional';
