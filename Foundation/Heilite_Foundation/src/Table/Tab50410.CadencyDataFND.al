table 50410 "Cadency Data FND"
{
    ...
    //   # Created New Fields:  51 - E-Mail For GLBAL
    //                          52 - E-Mail For GLTRAN
    //                          53 - E-Mail For SLBAL
    ...
    // ID changed from 55011 to 58095
    ...
    fields
    {
        ...
        field(51; "E-Mail For GLBAL"; Boolean)
        {
            Caption = 'E-Mail For GLBAL';
            Description = 'HEI.02';
            Editable = false;
        }
        field(52; "E-Mail For GLTRAN"; Boolean)
        {
            Caption = 'E-Mail For GLTRAN';
            Description = 'HEI.02';
            Editable = false;
        }
        field(53; "E-Mail For SLBAL"; Boolean)
        {
            Caption = 'E-Mail For SLBAL';
            Description = 'HEI.02';
            Editable = false;
        }
    }
