table 50142 "Purch. Inv. Header Add FND"
{
    // version NRQ157810,HEI.15

    // HEI.01 FDD-PURGAP027 IBM NASTAA02 11.06.2019 # Maximo POs Approval Flow
    //   # New Table created to extend Standard Table 122 - Purch. Inv. Header
    ...
    //                         50086 - Processed GR Transaction Zycus
    // BC Upgrade SHUKLP03 << Added in interface ext.
    Caption = 'Purch. Inv. Header Additional';
