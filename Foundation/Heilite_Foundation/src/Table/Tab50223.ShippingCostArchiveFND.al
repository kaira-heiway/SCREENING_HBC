table 50223 "Shipping Cost Archive FND"
{
    // version HEI.08

    // HEI.01 CHG2141694 IBM BULIMC01 13.10.2021#new table created to store the archive of shipping costs
    // HEI.02 CHG2132177 BULIMC01 IBM 06/05/2022 # new field added: "Own Fleet"
    //   #field ID48 and fieldID49 changed to FlowFields
    //   #new secondary key added for the flowfields created to T50215
    //   #DecimalPlaces property updated
    ...
    // HEI.06 CHG2167931 IBM SISUM01 22/11/2022 #add new fields with description HEI.06
    //   #change for all FlowFields fields the table. Set archive table
    //   #add the missing fields from T50208.
    // HEI.07 CHG2167931 IBM SISUM01 09/01/2023 - correct the field no in flowfield formula for the new fields
    // HEI.08 CHG2175297 IBM SISUM01 25/04/2023 HB3191 C2S Reconciliation Report Enhancement
    //   #create global function FindByNo

    Caption = 'Shipping Cost Archive';
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("RPM-SKU Relationship Arch FND"."RPM Unit Cost Sold Cust." where("Period Date" = FIELD("Period Date"),
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."Period RPM Unit Cost Transfer" where("Period Date" = FIELD("Period Date"),
                                                                                                      "Linked Item No." = FIELD("Item No.")));
        ...
        {
            CalcFormula = Lookup("Shipping Cost Archive FND"."Unit Cost-General Overheads ST" where("Source Document" = FILTER("Outbound Transfer"),
        ...
        {
            CalcFormula = Lookup("Shipping Cost Archive FND"."Unit Cost-Whse. Handling ST" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                              "Period Date" = FIELD("Period Date"),
                                                                                              "Item No." = FIELD("Item No."),
                                                                                              "Lot No. & Destination No." = FIELD("Lot No. & Location Code")));
            DecimalPlaces = 2 : 5;
        ...
        {
            CalcFormula = Lookup("Shipping Cost Archive FND"."Unit Cost-Whse. Overhead ST" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                              "Period Date" = FIELD("Period Date"),
                                                                                              "Item No." = FIELD("Item No."),
                                                                                              "Lot No. & Destination No." = FIELD("Lot No. & Location Code")));
            DecimalPlaces = 2 : 5;
        ...
        {
            CalcFormula = Lookup("Shipping Cost Archive FND"."Unit Cost-Internal Transfer ST" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                                 "Period Date" = FIELD("Period Date"),
                                                                                                 "Item No." = FIELD("Item No."),
                                                                                                 "Lot No. & Destination No." = FIELD("Lot No. & Location Code")));
            DecimalPlaces = 2 : 5;
        ...
        {
            CalcFormula = Lookup("Shipping Cost Archive FND"."Initial Origin ST" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                    "Period Date" = FIELD("Period Date"),
                                                                                    "Item No." = FIELD("Item No."),
                                                                                    "Lot No. & Destination No." = FIELD("Lot No. & Location Code")));
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."Net Weight (Kg)" where("Source Document" = FILTER("Outbound Transfer"),
                                                                               "Period Date" = FIELD("Period Date"),
                                                                               "Item No." = FIELD("Item No."),
                                                                               "Lot No." = FIELD("Lot No."),
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."Primary Allocated Amount" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                        "Period Date" = FIELD("Period Date"),
                                                                                        "Item No." = FIELD("Item No."),
                                                                                        "Lot No." = FIELD("Lot No."),
                                                                                        "Destination No." = FIELD("Location Code"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."General Overheads" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                 "Period Date" = FIELD("Period Date"),
                                                                                 "Item No." = FIELD("Item No."),
                                                                                 "Lot No." = FIELD("Lot No."),
                                                                                 "Destination No." = FIELD("Location Code"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."Warehouse Overheads" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                   "Period Date" = FIELD("Period Date"),
                                                                                   "Item No." = FIELD("Item No."),
                                                                                   "Lot No." = FIELD("Lot No."),
                                                                                   "Destination No." = FIELD("Location Code"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."Warehouse Handling" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                  "Period Date" = FIELD("Period Date"),
                                                                                  "Item No." = FIELD("Item No."),
                                                                                  "Lot No." = FIELD("Lot No."),
                                                                                  "Destination No." = FIELD("Location Code"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."Picking Factor" where("Source Document" = FILTER("Outbound Transfer"),
                                                                              "Period Date" = FIELD("Period Date"),
                                                                              "Item No." = FIELD("Item No."),
                                                                              "Lot No." = FIELD("Lot No."),
                                                                              "Destination No." = FIELD("Location Code")));
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."Period RPM Gen. Overh. Cust." where("Period Date" = FIELD("Period Date"),
                                                                                                     "Linked Item No." = FIELD("Item No."),
                                                                                                     "Customer No." = FIELD("Destination No."),
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."Period RPM Gen. Overh. IT" where("Period Date" = FIELD("Period Date"),
                                                                                                  "Linked Item No." = FIELD("Item No."),
                                                                                                  "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."Period RPM Whse. Overh. Cust." where("Period Date" = FIELD("Period Date"),
                                                                                                      "Linked Item No." = FIELD("Item No."),
                                                                                                      "Customer No." = FIELD("Destination No."),
                                                                                                      "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Sum("RPM - SKU Relationship FND"."Period RPM Whse. Handl. Cust." where("Period Date" = FIELD("Period Date"),
                                                                                              "Linked Item No." = FIELD("Item No."),
                                                                                              "Customer No." = FIELD("Destination No."),
                                                                                              "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."Period RPM Whse. Handl. IT" where("Period Date" = FIELD("Period Date"),
                                                                                                   "Linked Item No." = FIELD("Item No."),
                                                                                                   "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Lookup("Shipping Cost Archive FND"."OVE Unit Cost-Whse. Handl. ST" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                                "Period Date" = FIELD("Period Date"),
                                                                                                "Item No." = FIELD("Item No."),
                                                                                                "Lot No. & Destination No." = FIELD("Lot No. & Location Code")));
        ...
        {
            CalcFormula = Lookup("Shipping Cost Archive FND"."TRP Unit Cost-Whse. Handl. ST" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                                "Period Date" = FIELD("Period Date"),
                                                                                                "Item No." = FIELD("Item No."),
                                                                                                "Lot No. & Destination No." = FIELD("Lot No. & Location Code")));
        ...
        {
            CalcFormula = Lookup("Shipping Cost Archive FND"."FIX Unit Cost-Whse. Handl. ST" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                                "Period Date" = FIELD("Period Date"),
                                                                                                "Item No." = FIELD("Item No."),
                                                                                                "Lot No. & Destination No." = FIELD("Lot No. & Location Code")));
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."OVE Warehouse Handling" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                      "Period Date" = FIELD("Period Date"),
                                                                                      "Item No." = FIELD("Item No."),
                                                                                      "Lot No." = FIELD("Lot No."),
                                                                                      "Destination No." = FIELD("Location Code"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."TRP Warehouse Handling" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                      "Period Date" = FIELD("Period Date"),
                                                                                      "Item No." = FIELD("Item No."),
                                                                                      "Lot No." = FIELD("Lot No."),
                                                                                      "Destination No." = FIELD("Location Code"),
        ...
        {
            CalcFormula = Sum("Shipping Cost Archive FND"."FIX Warehouse Handling" where("Source Document" = FILTER("Outbound Transfer"),
                                                                                      "Period Date" = FIELD("Period Date"),
                                                                                      "Item No." = FIELD("Item No."),
                                                                                      "Lot No." = FIELD("Lot No."),
                                                                                      "Destination No." = FIELD("Location Code"),
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."OVE Prd. RPM Whse. Handl. Cust" where("Period Date" = FIELD("Period Date"),
                                                                                                       "Linked Item No." = FIELD("Item No."),
                                                                                                       "Customer No." = FIELD("Destination No."),
                                                                                                       "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."TRP Prd. RPM Whse. Handl. Cust" where("Period Date" = FIELD("Period Date"),
                                                                                                       "Linked Item No." = FIELD("Item No."),
                                                                                                       "Customer No." = FIELD("Destination No."),
                                                                                                       "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."FIX Prd. RPM Whse. Handl. Cust" where("Period Date" = FIELD("Period Date"),
                                                                                                       "Linked Item No." = FIELD("Item No."),
                                                                                                       "Customer No." = FIELD("Destination No."),
                                                                                                       "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."OVE Prd. RPM Whse. Handl. IT" where("Period Date" = FIELD("Period Date"),
                                                                                                     "Linked Item No." = FIELD("Item No."),
                                                                                                     "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."TRP Prd. RPM Whse. Handl. IT" where("Period Date" = FIELD("Period Date"),
                                                                                                     "Linked Item No." = FIELD("Item No."),
                                                                                                     "Own Fleet" = FIELD("Own Fleet")));
        ...
        {
            CalcFormula = Max("RPM-SKU Relationship Arch FND"."FIX Prd. RPM Whse. Handl. IT" where("Period Date" = FIELD("Period Date"),
                                                                                                     "Linked Item No." = FIELD("Item No."),
                                                                                                     "Own Fleet" = FIELD("Own Fleet")));
    ...
    keys
    {
        ...
        key(Key2; "Lot No. & Destination No.", "Item No.", "Posted Source Document")
        {
        }
        key(Key3; "Item No.", "Destination No.")
        {
        }
    }
    ...
    var
        ShippingCostAllocArchive: Record "Shipping Cost Archive FND";
        IsFound: Boolean;
    begin
        //HEI.08>>
        ShippingCostAllocArchive.SETRANGE("No.", DocNo);
        if ShippingCostAllocArchive.FINDFIRST() then
            IsFound := true;
        exit(IsFound);
        //HEI.08<<
    end;
