page 52019 "NPO Purchase Credit Memos"
{
    // version NAVW110.0.00.15052,DITW110.00.09,HEI.03
    ...
    // HEI.01 CHG2204474 IBM SRIVAS07 19.09.23 - Error message displayed when document date is in the future in all invoice processing pages
    //   # Added code in Post Action.
    // HEI.02 CHG2204474 IBM SRIVAS07 26.09.23 - Error message displayed when document date is in the future in all invoice processing pages
    //   # Added code in Post Action.
    //   # Added code in PostAndPrint Action.
    // HEI.03 CHG2204474 IBM SRIVAS07 16.10.23 - Error message displayed when document date is in the future in all invoice processing pages
    //   # Added code in Post Action.
    //   # Added code in PostAndPrint Action.
    //BC Upgrade SHARMP16 -- Old Id 50048 replace with new Id -52019
    ...
    Caption = 'NPO Purchase Credit Memos';
    CardPageID = "NPO Purchase Credit Memo";
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                //BC Upgrade VAMSIU01 --DRINK-IT field >>
        ...
        area(processing)
        {
            ...
            group("P&osting")
            {
                ...
                action(Post)
                {
                    ...
                    begin
                        rec.TESTFIELD("Document Date"); //HEI.03
                                                        //HEI.01>>
    ...
    begin
        ...
        rec.FILTERGROUP(2);
        rec.SETRANGE("Document Subtype Code FND", PurchasesPayablesSetup."NPO Subtype Code FND");//BC Upgrade VAMSIU01--added
        rec.FILTERGROUP(0);
        //HEI.01<<
    end;
