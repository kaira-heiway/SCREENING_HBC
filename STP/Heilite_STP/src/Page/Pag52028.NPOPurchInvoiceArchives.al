page 52028 "NPO Purch. Invoice Archives"
{
    // version NAVW110.0
    // BC Upgrade BHARDA11 >>
    // 1. OLD Page ID - 50041.
    // 2. Remove Drink-IT Field ("Document Subtype Code") and related code.
    // 3. Add ApplicationArea Property in Page , Fields , Part and actions.
    // BC Upgrade BHARAD11 <<
    ApplicationArea = All;
    UsageCategory = Lists;
    Caption = 'NPO Purch. Invoice Archives';
    CardPageID = "NPO Purchase Invoice Archive";
    Editable = false;
    PageType = List;
    ...
    begin
        ...
        Rec.FILTERGROUP(2);
        Rec.SETRANGE("Document Subtype Code FND", PurchasesPayablesSetup."NPO Subtype Code FND"); // BC Upgrade VAMSIU01 - added Drink-IT Field("Document Subtype Code")
        Rec.FILTERGROUP(0);
        //HEI.01<<
    end;
