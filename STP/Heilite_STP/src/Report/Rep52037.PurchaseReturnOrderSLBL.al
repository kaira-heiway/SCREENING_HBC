report 52037 "Purchase Return Order SLBL"
{
    // version HEI.11
    ...
    //   # New report created
    // ******************************************************************************************************
    // HEI.16 HT1806 IBM NANDIS01 27.01.2021
    //   # New report created for Sierra Leone opco copied from 50446
    //   # Updated layout changes by adding vendor name and email id from comp info


    // BC Upgrade KUMARS145 Nav ID report 50462 "Purchase Return Order SLBL"

    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Purchase Return Order SLBL.rdl';
    CaptionML = ENU = 'Purchase Return Order SLBL',
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            // BC Upgrade KUMARS145 column dependent on Drinkit field............>>
            ...
            column(SRMContractName_PurchaseHeader; "Purchase Header"."SRM Contract No. FND") { }
            column(SRMContractName2_PurchaseHeader; "Purchase Header"."SRM Contract Name FND") { }
            ...
            // column(FooterText; StringHelper.Copy(Format(FooterText))) { }// BC Upgrade KUMARS145 Dependent on Dotnet variable.
            column(FooterText; Format(FooterText)) { }// BC Upgrade KUMARS145 Dependent on Dotnet variable Changed.
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInfo_POLegalEmail; CompanyInfo."PO Legal Text Box E-Mail FND") { }
                            ...
                            begin
                                ...
                                repeat
                                    ...
                                    if DimText = '' then
                                        ...
                                        DimText :=
                                          StrSubstNo('%1, %2 %3', DimText, DimSetEntry2."Dimension Code", DimSetEntry2."Dimension Value Code");
                                    if StrLen(DimText) > MaxStrLen(OldDimText) then begin
                                        DimText := OldDimText;
                                        Continue := true;
                                        exit;
            ...
            begin
                ...
                // User.SetRange("User Name", "Created By");//HEI.12
    ...
    var
        ...
        LicenseCodeLbl: Label 'License Code';
    ...
    begin
        // with PurchaseHeader do begin // BC upgrade KUMARS145 Removed 'with' statement as it is deprecated.
