pageextension 52011 PostedPurchCrmemoSubformEXt extends "Posted Purch. Cr. Memo Subform"
{
    // version NAVW110.0,FINXL9.00,DITW110.00.08,HEI.07,HEI.08
    ...
    //HEI.07 and HEI.08 -//BC upgrade GUNREM01 fields added in Intercae
    ...
    layout
    {
        ...
        modify("No.")
        {
            ToolTipML = ENU = 'Specifies an item number that identifies the item or a general ledger account number that identifies the general ledger account used when posting the line.', FRA = 'Spécifie un numéro d''article qui identifie l''article ou un numéro de compte général qui identifie le compte général utilisé lors de la validation de la ligne.';
        ...
        modify("Indirect Cost %")
        {
            ...
            //Unsupported feature: Change Editable on ""Indirect Cost %"(Control 18)". Please convert manually.
        ...
        modify("Unit Price (LCY)")
        {
            ...
            //Unsupported feature: Change Editable on ""Unit Price (LCY)"(Control 20)". Please convert manually.
        ...
        modify("Line Amount")
        {
            ...
            //Unsupported feature: Change AutoFormatType on ""Line Amount"(Control 70)". Please convert manually.


            //Unsupported feature: Change AutoFormatExpr on ""Line Amount"(Control 70)". Please convert manually.


            //Unsupported feature: Change Editable on ""Line Amount"(Control 70)". Please convert manually.
        ...
        modify("Insurance No.")
        {
            ...
            //Unsupported feature: Change Editable on ""Insurance No."(Control 24)". Please convert manually.
        ...
        modify("Budgeted FA No.")
        {
            ...
            //Unsupported feature: Change Editable on ""Budgeted FA No."(Control 32)". Please convert manually.
        ...
        modify("Depr. until FA Posting Date")
        {
            ...
            //Unsupported feature: Change Editable on ""Depr. until FA Posting Date"(Control 26)". Please convert manually.
        ...
        modify("Depreciation Book Code")
        {
            ...
            //Unsupported feature: Change Editable on ""Depreciation Book Code"(Control 30)". Please convert manually.
        ...
        modify("Depr. Acquisition Cost")
        {
            ...
            //Unsupported feature: Change Editable on ""Depr. Acquisition Cost"(Control 28)". Please convert manually.
        ...
        {
            field(TotalCADAmount; TotalPurchCrMemoHdr."CAD Amount FND")
            {
                ApplicationArea = All;
                AutoFormatExpression = TotalPurchCrMemoHdr."Currency Code";
                // CaptionClass = DocumentTotals.GetTotalCADCaption(TotalPurchCrMemoHdr."Currency Code");
                CaptionClass = HeinekenBCCustomFunctions.GetTotalCADCaption(TotalPurchCrMemoHdr."Currency Code");
        ...
        addafter("Total Amount Incl. VAT")
        {
            field(TotalInclCAD; TotalInclCAD)
            {
                ApplicationArea = All;
                AutoFormatExpression = TotalPurchCrMemoHdr."Currency Code";
                // CaptionClass = DocumentTotals.GetTotalInclCADCaption(TotalPurchCrMemoHdr."Currency Code");
                CaptionClass = HeinekenBCCustomFunctions.GetTotalInclCADCaption(TotalPurchCrMemoHdr."Currency Code");
    ...
    actions
    {
        ...
        {
            CaptionML = ENU = 'Item Return Shipment &Lines', FRA = '&Lignes expédition retour article';
        }
        //BC Upgrade GUNREM01
    ...
    begin
        ...
        IF GeneralLedgerSetup."Enable CAD FND" THEN BEGIN
            IF TotalPurchCrMemoHdr."CAD Amount FND" <> 0 THEN BEGIN
                PurchCrMemoLine.RESET;
                PurchCrMemoLine.SETRANGE("Document No.", TotalPurchCrMemoHdr."No.");
                PurchCrMemoLine.SETFILTER("CAD Attached to Line No. FND", '<>%1', 0);
                IF PurchCrMemoLine.FINDFIRST THEN
                    TotalInclCAD := TotalPurchCrMemoHdr."Amount Including VAT"
                ELSE
                    TotalInclCAD := TotalPurchCrMemoHdr."Amount Including VAT" + TotalPurchCrMemoHdr."CAD Amount FND";
            END ELSE
                TotalInclCAD := TotalPurchCrMemoHdr."Amount Including VAT";
        END;
        //HEI.04<<
    ...
    */
    ...
    if GeneralLedgerSetup."Enable CAD" then begin
      if TotalPurchCrMemoHdr."CAD Amount" <> 0 then begin
        PurchCrMemoLine.RESET;
        PurchCrMemoLine.SETRANGE("Document No.",TotalPurchCrMemoHdr."No.");
        PurchCrMemoLine.SETFILTER("CAD Attached to Line No.",'<>%1',0);
        if PurchCrMemoLine.FINDFIRST then
          TotalInclCAD := TotalPurchCrMemoHdr."Amount Including VAT"
        else
          TotalInclCAD := TotalPurchCrMemoHdr."Amount Including VAT" + TotalPurchCrMemoHdr."CAD Amount";
      end else
        TotalInclCAD := TotalPurchCrMemoHdr."Amount Including VAT";
    end;
    //HEI.04<<
