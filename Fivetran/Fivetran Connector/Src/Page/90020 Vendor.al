    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                //Bc Upgrade SAIA01 >>
                field(duns_number; Rec."Duns Number FND")
                {
                    Caption = 'Duns Number';
                }
                //Bc Upgrade SAIA01 <<
                ...
                //Bc Upgrade SAIA01 >>
                field(global_delete; Rec."Global Delete FND")
                {
                    Caption = 'Global Delete';
                }
                field(global_vendor_number; Rec."Global Vendor Number FND")
                {
                ...
                //Bc Upgrade SAIA01 >>
                field(industry_key; Rec."Industry Key FND")
                {
                ...
                //Bc Upgrade SAIA01 >>
                field(vendor_type; Rec."Vendor Type FND")
                {
                    Caption = 'Vendor Type';
                }
                //Bc Upgrade SAIA01 <<
