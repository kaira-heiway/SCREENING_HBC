    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field(postedWhseShpmtNoFND; Rec."Posted Whse. Shpmt No. FND")
                {
                    Caption = 'Posted Whse. Shipment No.';
                }
                field(whseShipmentNoFND; Rec."Whse. Shipment No. FND")
                {
                    Caption = 'Whse. Shipment No.';
                }
                field(xmlPrintedFND; Rec."XML Printed FND")
                {
                    Caption = 'XML Printed';
                }
                field(fiscalDocumentFND; Rec."Fiscal Document FND")
                {
                    Caption = 'Fiscal Document';
                }
                field(fiscalDocumentNoFND; Rec."Fiscal Document No. FND")
                {
                    Caption = 'Fiscal Document No.';
                }
                field(printStationSerialFND; Rec."Print Station Serial FND")
                {
                    Caption = 'Print Station Serial';
                }
                field(printDateTimeFND; Rec."Print Date/Time FND")
                {
                    Caption = 'Print Date/Time';
                }
                field(salesRoutesFND; Rec."Sales Routes FND")
                {
                    Caption = 'Sales Routes';
                }
                field(bonusCreditMemoFND; Rec."Bonus Credit Memo FND")
                {
                    Caption = 'Bonus Credit Memo';
                }
                field(vansSalesRouteFND; Rec."Vans Sales Route FND")
                {
                    Caption = 'Vans Sales Route';
                }
                field(docAmountInclVATFND; Rec."Doc. Amount Incl. VAT FND")
                {
                    Caption = 'Doc. Amount Incl. VAT FND';
                }
                field(docAmountVATFND; Rec."Doc. Amount VAT FND")
                {
                    Caption = 'Doc. Amount VAT FND';
                }
                field(fiscalPrinterStatusFND; Rec."Fiscal Printer Status FND")
                {
                    Caption = 'Fiscal Printer Status';
                }
                field(loadNoFND; Rec."Load No. FND")
                {
                    Caption = 'Load No.';
                }
                field(sequenceNoFND; Rec."Sequence No. FND")
                {
                    Caption = 'Sequence No.';
                }
                field(billOfLadingNoFND; Rec."Bill Of Lading No. FND")
                {
                    Caption = 'Bill Of Lading No.';
                }
                field(vesselNameFND; Rec."Vessel Name FND")
                {
                    Caption = 'Vessel Name';
                }
                field(etdFND; Rec."ETD FND")
                {
                    Caption = 'ETD';
                }
                field(etaFND; Rec."ETA FND")
                {
                    Caption = 'ETA';
                }
                field(airWayBillNoFND; Rec."Air Way Bill No FND")
                {
                    Caption = 'Air Way Bill No';
                }
                field(commodityCodeFND; Rec."Commodity Code FND")
                {
                    Caption = 'Commodity Code';
                }
                field(customTariffCodeFND; Rec."Custom Tariff Code FND")
                {
                    Caption = 'Custom Tariff Code';
                }
                field(inCoTermsFND; Rec."InCo Terms FND")
                {
                    Caption = 'InCo Terms';
                }
                field(suppressPOSInterfaceFND; Rec."Suppress POS Interface FND")
                {
                    Caption = 'Suppress POS Interface';
                }
                field(countryOfOriginFND; Rec."Country of Origin FND")
                {
                    Caption = 'Country of Origin';
                }
                field(specialOrderFND; Rec."Special Order FND")
                {
                    Caption = 'Special Order';
                }
                field(invoiceReceiptNoFND; Rec."Invoice Receipt No. FND")
                {
                    Caption = 'Invoice Receipt No.';
                }
                field(sendDocumentFND; Rec."Send Document FND")
                {
                    Caption = 'Send Document FND';
                }
                field(mailSentFND; Rec."Mail Sent FND")
                {
                    Caption = 'Mail Sent';
                }
