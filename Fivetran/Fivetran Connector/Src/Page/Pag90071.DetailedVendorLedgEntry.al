...
page 90071 "Detailed Vendor Ledg. Entry"
{
    APIGroup = 'standardEndpoints';
    APIPublisher = 'fivetran';
    APIVersion = 'v1.0';
    ApplicationArea = All;
    Caption = 'Detailed Vendor Ledg. Entry API';
    DelayedInsert = true;
    ODataKeyFields = SystemId;
    DataAccessIntent = ReadOnly;
    Editable = false;
    EntityName = 'detailedVendorLedgEntry';
    EntitySetName = 'detailedVendorLedgEntries';
    PageType = API;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field(vendor_posting_group; Rec."Vendor Posting Group 101FDW")
                {
