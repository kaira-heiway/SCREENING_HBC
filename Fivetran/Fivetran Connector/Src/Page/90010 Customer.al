    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                //BC UPGRADE KUMARR78 ++07-07-2026
                ...
                field(blockedReasonCode; Rec."Blocked Reason Code FND")
                {
                    Caption = 'Blocked Reason Code';
                }

                field(nettingAgreement; Rec."Netting Agreement FND")
                {
                ...
                field(riskCategory; Rec."Risk Category FND")
                {
                    Caption = 'Risk Category';
                }

                field(riskScore; Rec."Risk Score FND")
                {
                    Caption = 'Risk Score';
                }

                field(taxRegistrationNumber; Rec."Tax Registration Number FND")
                {
                    Caption = 'Tax Registration Number';
                }

                field(nationalIdentityCard; Rec."National Identity Card FND")
                {
                    Caption = 'National Identity Card';
                }

                field(approvalOfAlcohol; Rec."Approval Of Alcohol FND")
                {
                    Caption = 'Approval Of Alcohol';
                }

                field(salesRoutes; Rec."Sales Routes FND")
                {
                ...
                field(returnOrderMandatory; Rec."Return Order Mandatory FND")
                {
                    Caption = 'Return Order Mandatory';
                }

                field(accountGroup; Rec."Account Group FND")
                {
                    Caption = 'Account Group';
                }

                field(additionalRPMReturn; Rec."Additional RPM Return FND")
                {
                    Caption = 'Additional RPM Return';
                }

                field(openSalesRPMValue; Rec."Open Sales RPM Value FND")
                {
                    Caption = 'Open Sales RPM Value';
                }

                field(rpmExposure; Rec."RPM Exposure FND")
                {
                    Caption = 'RPM Exposure';
                }

                field(packagingCreditValuePCV; Rec."Packaging Credit Value PCV FND")
                {
                    Caption = 'Packaging Credit Value (PCV)';
                }

                field(defaultBlocked; Rec."Default Blocked FND")
                {
                    Caption = 'Default Blocked';
                }

                field(checkFFEBalanceFFESecurityAmount; Rec."Check Bal/FFE security Amt FND")
                {
                    Caption = 'Check FFE Bal./FFE Security Amt.';
                }

                field(sensitivePaymentBlock; Rec."Sensitive Payment Block FND")
                {
                    Caption = 'Sensitive Payment Block';
                }

                field(sensitiveWorkflowBlock; Rec."Sensitive Workflow Block FND")
                {
                    Caption = 'Sensitive Workflow Block';
                }

                field(contractType; Rec."Contract Type FND")
                {
                    Caption = 'Contract Type';
                }

                field(customerDescription; Rec."Customer Description FND")
                {
                    Caption = 'Customer Description';
                }

                field(compensateRPMDifferences; Rec."Compensate RPM Differences FND")
                {
                ...
                field(tradingEndDate; Rec."Trading End Date FND")
                {
                    Caption = 'Trading End Date';
                }

                field(longitudeCoordinate; Rec."Longitude Coordinate FND")
                {
                    Caption = 'Longitude Coordinate';
                }

                field(latitudeCoordinate; Rec."Latitude Coordinate FND")
                {
                    Caption = 'Latitude Coordinate';
                }

                field(availForSalesReturnOrder; Rec."Avail.for Sales/ReturnOrd. FND")
                {
                    Caption = 'Available for Sales/Return Order';
                }

                field(semId; Rec."SEM Id FND")
                {
                    Caption = 'SEM Id';
                }

                field(freeGoodsAccountingHNK; Rec."Free Goods Accounting HNK FND")
                {
                    Caption = 'Free Goods Accounting (HNK)';
                }
                field(depositLimitLCY; Rec."Deposit Limit (LCY) 104FDW")
                {
                ...
                field(invoicePeriod; Rec."Invoice Period 101FDW")
                {
                ...
                field(emptyGoodsStatementOn; Rec."Statement On 104FDW")
                {
                ...
                field(exclusivity; Rec."Exclusivity Cust. 106FDW")
                {
                    Caption = 'Exclusivity';
                }
