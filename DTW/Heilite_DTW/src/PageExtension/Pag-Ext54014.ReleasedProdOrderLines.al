pageextension 54014 ReleasedProdOrderLinesExt extends "Released Prod. Order Lines"
{
    ...
    // DITW15.00.00.38-PRODW14.00.00.17 DDR 14/12/2010 issue 1127 Replaced static text Lot required by call function IsRequired()
    ...
    // MANXL7.00.001 DAT 03/03/2014 #: Version Management
    ...
    layout
    {
        ...
        modify("Routing Version Code")
        {
            ...
            begin
                ...
                //COMMIT;
                WHSUTILS.OnAfterValidateProdBOMVerCodeProdOrdeLine(Rec, xRec, Rec.FIELDNO(Rec."Routing Version Code"));
                //HEI.02<<
            end;
        }
        ...
        // BC Upgrade - RD03 - Page level field mapping -- <<
        //BC Upgrade GUNREM01 >>
        moveafter("Zone Code FND"; "Bin Code")
        //BC Upgrade GUNREM01 <<
        ...
        //Unsupported feature: CodeInsertion on ""Routing Version Code"(Control 42)". Please convert manually.
        ...
        */
        ...
        //Unsupported feature: CodeInsertion on ""Production BOM Version Code"(Control 38)". Please convert manually.
    ...
    actions
    {
        ...
        modify(ItemAvailabilityByEvent)
        {
        ...
        modify(ItemAvailabilityByBOMLevel)
        {
        ...
        addafter(ItemTrackingLines)
        {
            ...
            action(Operations)
            {
                ...
                Description = 'QXL9.00';
                Image = Production;
                RunObject = Page "Prod. Order Operations";
    ...
    var
        //    QualitySetup: Record "Quality Setup";//BCUPGRADE YADAVM09 Drink it object
        //   QualityManagement: Codeunit "Quality Management";//BCUPGRADE YADAVM09 Drink it object
        LotNo: Code[20];
        ...
        //BrewingSetup: Record "Production Setup";//BCUPGRADE YADAVM09 Drink it object
