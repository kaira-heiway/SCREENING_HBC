page 54006 "FPO - Yeast"
{
    // version Role,HEI.02
    //BC Upgrade Kamnay01 Original(Heilite) page id 50190
    ...
    //Bc Upgrade YADAVM09 drink it filed and code commented
    //Bc Upgrade YADAVM09 Caption added for field Blocked
    // Page action property promoted changes false to true for below actions:
    ...
    begin
        ...
        //decFinishedQty := fctCalcQuantityFinished();//Bc Upgrade Drink it code commented
        //>> DITW111.00.13 ISL NRQ#84282

        //ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue(Rec."No."); //HEI.05<< //Bc Upgrade Drink it field dependency
    end;
    ...
    begin
        ...
        */ //Bc Upgrade YADAVM09 Drink it code commented<<
        ...
        //HEI.03<<
        //HEI.02 SETFILTER(Description,'%1','@*propagated*');
        //HEI.02+
        Rec.SETFILTER("Description 2", '%1', '@*propagated*');
        //HEI.02-
    end;
