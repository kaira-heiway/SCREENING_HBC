page 54020 "Firm Planned Prod. Orders MRC"
{
    // version NAVW110.0,DITW110.00.12A,HEI.02
    //BC Upgrade Kamnay01 Original(Heilite) page id 50430
    ...
    //Bc Upgrade YADAVM09 Page action Property changed Promoted false to true for below action:
