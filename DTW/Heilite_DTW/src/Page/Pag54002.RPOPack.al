...
{
    // version Role,HEI.03
    //BC Upgrade Kamnay01 Original(Heilite) page id 50201
    ...
    // HEI.03 Defect #2799 IBM NASTAA02 24.09.2018 # Wort RPO tile not acesible
    ...
    // HEI.05 CHG0270593 - IBM ISYED01 2.15.2019
    ...
    // HEI.06 CHG2013123 IBM GAVANM01 01/11/2019
    ...
    //Bc Ugrade YADAVM09 HEI.06 block due it dependence on drink it object and
    //# Property changes for below actions 
    ...
    begin
       ...
       if rMANXLSetup.READPERMISSION then begin
           ...
           decActualVsPlannedQty := fctCalcQuantityPlannedVsAct(decPlannedQty, decFinishedQty); //HEI.04
                                                                                                //decActualVsPlannedQty:= fctCalcQuantityPlannedVsAct(decPlannedQty); //HEI.04 //08/10/2018 INC
       ...
       */ //Bc Upgrade YADAVM09 Drink it code commented<<
        ...
        //HEI.05<<
        //ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue(Rec."No."); //HEI.06//Bc Ugrade YADAVM09 due it dependence on drink it
    end;
    /* Bc Upgrade YADAVM09 Drink it code commented>>
