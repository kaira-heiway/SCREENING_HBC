page 54004 "FPPO - Yeast"
{
    // version Role,HEI.03
    //BC Upgrade Kamnay01 Original(Heilite) page id 50188
    ...
    // #Application Area All Added for fields
    // Page Action property Promoted changes false to true for below action
    ...
    begin
        ...
        Rec.SETFILTER(Status, 'Firm Planned');
        //SETFILTER("Location Code",GeneralOpCoSetup."RC Location Code");
        //HEI.04>>
