page 54009 "FPO <> Yeast"
{
    // version Role,HEI.02
    //BC Upgrade Kamnay01 Original(Heilite) page id 50193
    ...
    //Bc Upgrade YADAVM09 blocked filed caption Added.
    //Bc Upgrade YADAVM09 page action property promoted changes from false to true for below actions:
    ...
    begin
        ...
        //decFinishedQty := fctCalcQuantityFinished();//Bc Upgrade YADAVM09 Drink it function commented
        //>> DITW111.00.13 ISL NRQ#84282
        //HEI.06>>
        LotNo := HeinekenGlobal.GetLotItemTracking(Rec."No.");
        //HEI.06<<

        // ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue(Rec."No."); //HEI.05//Bc Upgrade YADAVM09 Drink it field dependency commented
    end;

    trigger OnNewRecord(BelowxRec: Boolean);
    begin
        //<< DITW111.00.13 ISL 13/09/2018 NRQ#84282
        //decFinishedQty := 0; //Bc Upgrade YADAVM09 Drink it code commented
        //>> DITW111.00.13 ISL NRQ#84282
    end;
    ...
    begin
        ...
        //HEI.03<<
        Rec.SETFILTER("Description 2", '<>%1', '@*propagated*'); //HEI.02
    end;
