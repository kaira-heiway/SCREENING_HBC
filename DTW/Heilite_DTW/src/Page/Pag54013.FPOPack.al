page 54013 "FPO Pack"
//Page 50202  "FPO - Pack"//Bc Upgrade YADAVM09
{//BC Upgrade Kamnay01 Original(Heilite) page id 50202
    // version Role
    ...
    // HEI.02 RFC-CHG0255624 IBM.LS 16.11.2018
    ...
    //Bc Upgrade YADAVM09 Caption Application area property added for page and fields.
    //Bc Upgrade YADAVM09 Promoted property changes false to true for below action:
    // #Prod. Order - Detail Calc.
    // #Prod. Order - Precalc. Time
    // #Production Order Job Card
    // #Production Order - Picking List
    //Bc Upgrade YADAVM09 Change page name and caption.

    //Caption = 'Finished Production Orders';//Bc Upgrade YADAVM09
    Caption = 'FPO Pack';//Bc Upgrade YADAVM09
    ...
    begin
        ...
        //ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue("No."); //HEI.03/* //Bc Upgrade YADAVM09 Dependency on drink it field
    end;
    ...
    begin
        ...
        //HEI.02>>
        //SETFILTER("Zone Code",'%1',GeneralOpCoSetup."RC Packaging Zone Code");
        Rec.SETFILTER("Zone Code FND", GeneralOpCoSetup."RC Packaging Zone Code");
        //HEI.02<<
    end;
