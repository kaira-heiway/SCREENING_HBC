page 54005 "RPO - Yeast"
{
    // version Role,HEI.04
    //BC Upgrade Kamnay01 Original(Heilite) page id 50189
    ...
    // Bc Upgrade YADAVM09 Page action property promoted changes false to true for below actions
    ...
    begin
        ...
        */ //Bc Upgrade YADAVM09 Drink it code commented<<
        ...
        // ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue(Rec."No."); //HEI.07//Bc Upgrade YADAVM09 Depnedency on Drink it field
    end;
    ...
    */ //Bc Upgrade YADAVM09 Drink it code Commented<<
    ...
    begin
        ...
        //HEI.05<<
        //HEI.03 SETFILTER(Description,'%1','@*propagated*');
        //HEI.03+
    ...
    var
        ...
        //rMANXLSetup: Record "Manufacturing XL Setup";//Bc Upgrade YADAVM09 Drink it object commented
