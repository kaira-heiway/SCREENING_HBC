...
Page 54019 "FPO Filtration Capacity"
//page 50199 "FPO <> Filtration Capacity"//Bc Upgrade YADAVM09 page name change
//BC Upgrade Kamnay01 Original(Heilite) page id 50199
{
    // version Role,HEI.02
    ...
    //Bc Upgrade YADAVM09 Blocked field caption added Admin. Completed.
    //Bc Upgrade YADAVM09 Application area property added for page and field.
    //Bc Upgrade YADAVM09 Page action property changes false to true for below action
    ...
    //Caption = 'Finished Production Orders';//Bc Upgrade YADAVM09
    Caption = 'FPO Filtration Capacity';//Bc Upgrade YADAVM09
    ...
    begin
        ...
        //decFinishedQty := fctCalcQuantityFinished();//Bc Upgrade drink it function commented
        //>> DITW111.00.13 ISL NRQ#84282
        //ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue("No."); //HEI.05 // Bc Upgrade YADAVM09 Drink it field and code commented
    end;
    ...
    begin
        ...
        //HEI.03<<
        Rec.SETFILTER("Description 2", '<>%1', '@*filtration*'); //HEI.02
    end;
