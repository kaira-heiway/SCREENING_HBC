page 54015 "RPO - Filtration Capacity"
{//BC Upgrade Kamnay01 Original(Heilite) page id 50195
    // version Role,HEI.04
    ...
    //Bc Upgrade YADAVM09 Applicatio Area property added for page and fields.
    //Bc Upgrade YADAVM09 page action Promoted property changes false to true to handle PromotedCategory
    ...
    begin
        ...
        */ //Bc Upgrade YADAVM09 Drink it code commented<<
        ...
        //HEI.06<<
        //ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue("No."); //HEI.07//Bc Upgrade YADAVM09 Drink it field dependency
    end;
    ...
    */ //Bc Upgrade YADAVM09 Drink it code commented<<
    ...
    begin
        ...
        //HEI.05<<
        //HEI.03 SETFILTER(Description,'%1','@*filtration*');
        //HEI.03+
