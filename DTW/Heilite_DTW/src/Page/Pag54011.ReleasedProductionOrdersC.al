page 54011 "Released Production Orders C"
{
    // version Role,HEI.03
    //BC Upgrade Kamnay01 Original(Heilite) page id 50181
    ...
    Caption = 'Released Production Orders C';
    ...
    begin
        ...
        if rMANXLSetup.READPERMISSION then begin
            ...
            decActualVsPlannedQty := fctCalcQuantityPlannedVsAct(decPlannedQty, decFinishedQty);//HEI.03
        ...
        */ //Bc Upgrade YADAVM09 Drink it field commented<<
        ...
        //ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue("No."); //HEI.05*/ //Bc Upgrade YADAVM09 Drink it field dependency
    end;
