page 54038 "DtW  Bev Prod Shift Leader RC"
{
    // version Role

    // HEI.01 CHG2119213 IBM BHATTA09 02.08.2021
    //   # Quick Access ListPart page added
    //   # My Items and Report Inbox Part pages are removed
    // BC Upgrade BHARDA11 >>
    // 1. OLD Page ID - 50177.
    // 2. Remove All Missing Pages Actions ("Quick Access","Connect Online","Item Availability by Timeline","Production Forecast Names",,
    // 3. Page "Transfer Lists" is obsolet so we are using "Transfer Orders".
    // BC Upgrade BHARAD11 <<
    ApplicationArea = All;
    Caption = 'Role Center';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            //     }
            // }
            part(Mustwort; "Wort Must Cue Part")
            {
                ApplicationArea = basic, suite;
                AccessByPermission = TableData "Activities Cue" = I;

            }
            part(Fermentation; "Fermentation Cue Part")
            {
                ApplicationArea = Basic, Suite;
            }
            part(FiltrationMixing; "Filtration Cue Part")
            {
                ApplicationArea = Basic, Suite;
            }
            part(packaging; "Packaging Cue Part")
            {
                ApplicationArea = Basic, Suite;
            }
            part(masterData; "Master Data Cue Part")
            {
                ApplicationArea = Basic, suite;
            }
            group(Control1900724708)
            {
                ...
                // BC Upgrade BHARDA11 >> ----Page "Quick Access" page Missing in BC
                ...
                // BC Upgrade BHARDA11 >> ----Page "Connect Online" page Missing in BC
    ...
    actions
    {
        area(reporting)
        {
            ...
            //     Image = "Report";
            //     RunObject = Report "Item Availability by Quality";
            // }
        ...
        // {
        // }
        // BC Upgrade BHARDA11 >> ----"Item Availability by Timeline" Page missing in BC
        ...
        area(embedding)
        {
            ...
            // // BC Upgrade BHARDA11 >> ----"Production Forecast Names" page is missing in BUsiness Central
            ...
            //         Image = Document;
            //         RunObject = Page "Transfer Order"; // BC Upgrade BHARDA11 ---"Transfer Lists" is obsolet.
            //     }
            //     action(Vendors)
            //     {
            //         ApplicationArea = All;
        ...
        area(processing)
        {
            ...
            // }
            // BC Upgrade BHARDA11 >> ----Page "Item Availability by Timeline" missing in BC
            // action("Item Availability by Timeline")
            // {
            //     ApplicationArea = All;
            //     Caption = 'Item Availability by Timeline';
