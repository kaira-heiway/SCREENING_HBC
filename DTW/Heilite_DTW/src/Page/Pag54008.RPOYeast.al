page 54008 "RPO <> Yeast"
{
    // version Role,HEI.04
    //BC Upgrade Kamnay01 Original(Heilite) page id 50192
    ...
    // Bc Upgrade YADAVM09 Property added Application area all for field and page
    //Bc Upgrade YADAVM09 page action Promoted property changes false to true for below actions
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = all;
                    Caption = 'Admin. Completed';//Bc Upgrade YADAVM09
                }
    ...
    actions
    {
        area(navigation)
        {
            group("Pro&d. Order")
            {
                ...
                /* //Bc Upgrade YADAVM09Drink it Action commented>>
    ...
    */ //Bc Upgrade YADAVM09 Drink it code commented<<
        ...
        // ILEStrengthSpecValue := HeinekenGlobal.GetStrengthSpecValue(Rec."No."); //HEI.07/* //Bc Upgrade YADAVM09 Drink it field dependency code commented
    end;
    ...
    begin
        ...
        //HEI.05>>
        //SETFILTER("Zone Code",'%1',GeneralOpCoSetup."RC F&Mat Zone Code");
        Rec.SETFILTER("Zone Code FND", GeneralOpCoSetup."RC F&Mat Zone Code");
        //HEI.05<<
        Rec.SETFILTER("Description 2", '<>%1', '@*propagated*'); //HEI.03
    end;
    ...
    var
        ...
        //rMANXLSetup: Record "Manufacturing XL Setup";//Bc Upgrade Drink it code commented
