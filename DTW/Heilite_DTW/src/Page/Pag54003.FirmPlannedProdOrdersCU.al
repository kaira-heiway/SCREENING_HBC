page 54003 "Firm Planned Prod. Orders - CU"
{
    // version Role,HEI.03
    //BC Upgrade Kamnay01 Original(Heilite) page id 50204
    ...
    // HEI.03 Bugfixing Panama IBM NASTAA02 30.07.2018 #Filer Pane not displayed on Open Page
    //   # Changed "Show Filter" from No to Yes
    ...
    //Bc Upgrade YADAVM09 Promoted Action property set to true for below page actions
    ...
    begin
        ...
        //Rec.SetSecurityFilterOnRespCenter();//Bc Upgrade YADAVM09 Drink it field commented
        // >>DITW18.00.06 MSF 26/02/2015 DIT-770 #1192
        */ //Bc Upgrade Drink it code commented<<
        ...
        //HEI.04>>
        //SETFILTER("Zone Code",'%1',GeneralOpCoSetup."RC Brewing Zone code");
