report 53091 "Sales Cr Memo La Reunion"
{
    // version HEI.08

    // HEI.01 FDD-HT637 IBM NASTAA02 27.01.2020 # Invoice Cr Memo Proforma Inv LaReunion
    //   # New Report created using Report 50379 - Sales Invoice La Reunion
    ...
    // HEI.08 CHG2192206 HB3312 IBM BHANDS01 10.07.2023 # Lareunion-Local billing documents update request
    //   # Added new variable SIREN Client for Bill-to Customer
    //   # Updated the report layout to adjust new changes
    //# RD03
    //   # BC UPGRADE RD03 - DITW Fields, Setrange Functions are blocked
    //   # BC UPGRADE RD03 - FRA Fields, Setrange Functions are blocked
    //   # BC UPGRADE RD03 - DITW Record Variables are blocked



    Caption = 'Sales Credit Memo La Reunion';
    ...
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Sales Cr Memo La Reunion.rdl';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(CreditMemoNoLbl; InvoiceNoLbl)
            {
            }
            column(ReceiptNo; ReceiptNo)
            {
            }
            column(SalesCrMemoHeader_OrderNo; "Return Order No.")
            {
            }
            column(SalesCrMemoHeader_OrderDate; FORMAT("Document Date", 0, '<day,2>/<month,2>/<year4>'))
            {
                Description = 'HEI.07';
            }
            column(SalesCrMemoHeader_ShipmentDate; FORMAT("Posting Date", 0, '<day,2>/<month,2>/<year4>'))
            {
                Description = 'HEI.07';
            }
            column(SalesCrMemoHeader_DueDate; FORMAT("Due Date", 0, '<day,2>/<month,2>/<year4>'))
            {
                Description = 'HEI.07';
            }
            column(SalesCrMemoHeader_SalesRoutes; Customer."Sales Routes FND")
            {
            }
            column(SalesCrMemoHeader_LocationCode; "Location Code")
            {
            }
            column(SalesCrMemoHeader_ExternalDocNo; "External Document No.")
            {
            }
            column(SalesCrMemoHeader_PaymentTermsCode; PaymentTerms.Description)
            {
            }
            ...
            column(SalesCrMemoHeader_AmountInclVAT; "Amount Including VAT")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(SalesCrMemoLine_No_Description; NoDescription)
                        {
                        }
                        column(SalesCrMemoLine_OctroiGtin; OctroiGtin)
                        {
                        }
                        column(SalesCrMemoLine_Quantity; Quantity)
                        {
                        }
                        column(SalesCrMemoLine_TranslatedUoM; TranslatedUoM)
                        {
                        }
                        ...
                        column(SalesCrMemoLine_VATPercent; "VAT %")
                        {
                        }
                        ...
                        column(SalesCrMemoLine_LineAmount; "Line Amount")
                        {
                        }
                        column(SalesCrMemoLine_Type; Type)
                        {
                        }
                        ...
                        var
                            ...
                            ChargeInvoiceLine: Record "Sales Cr.Memo Line";
                            ChargeInvoiceLine2: Record "Sales Cr.Memo Line";
                        ...
                        begin
                            ...
                            if Type = Type::Item then begin
                                ...
                                if ItemCrossReference.FINDFIRST() then
                                    OctroiGtin := ItemCrossReference."Reference No.";//BC UPGRADE RD03 Field Replaced in BC with "Reference No."
                                if OctroiGtin <> '' then
                            ...
                            if Type = Type::Item then begin
                                ...
                                // BC Upgrade RD03 Drinkit Field Commented .......>>
                                //ChargeInvoiceLine.SETRANGE("Item Charge Type", ChargeInvoiceLine."Item Charge Type"::Discount);
                                // BC Upgrade RD03 Drinkit Field Commented .......<<
                            ...
                            if Type = Type::Item then begin
                                ...
                                //HEI.04>>
                                // BC Upgrade RD03 FRA Field Commented .......>>
                                //IF "Free Item" THEN
                            ...
                            if Type = Type::Item then begin
                                ...
                                ChargeInvoiceLine2.SETRANGE("Attached to Line No.", "Line No.");
                                // BC Upgrade RD03 Drinkit Field Commented .......>>
                                //ChargeInvoiceLine2.SETFILTER("Item Charge Type", '%1|%2', ChargeInvoiceLine2."Item Charge Type"::Discount, ChargeInvoiceLine2."Item Charge Type"::Tax);
                                // BC Upgrade RD03 Drinkit Field Commented .......<<
                                if ChargeInvoiceLine2.FINDSET() then
                                    repeat
                    ...
                    dataitem(Totals; "Integer")
                    {
                        ...
                        begin
                            ...
                            MontantHT := 0;
                            SalesCrMemoLine2.SETRANGE("Document No.", "Sales Cr.Memo Header"."No.");
                            // BC Upgrade RD03 Drinkit Field Commented .......>>
                            //SalesCrMemoLine2.SETFILTER("Item Charge Type", '<>%1', SalesCrMemoLine2."Item Charge Type"::Deposit);
                            // BC Upgrade RD03 Drinkit Field Commented .......<<
                            if SalesCrMemoLine2.FINDSET() then
                                repeat
                                    MontantHT += SalesCrMemoLine2."Line Amount";
                            ...
                            if SalesCrMemoLine2.FINDSET() then
                                repeat
                                    TotalTTC += SalesCrMemoLine2."Amount Including VAT";
                                until SalesCrMemoLine2.NEXT() = 0;
                            ...
                            SalesCrMemoLine2.SETRANGE("Document No.", "Sales Cr.Memo Header"."No.");
                            // BC Upgrade RD03 Drinkit Field Commented .......>>
                            //SalesCrMemoLine2.SETRANGE("Item Charge Type", SalesCrMemoLine2."Item Charge Type"::Deposit);
                            // BC Upgrade RD03 Drinkit Field Commented .......<<
                            if SalesCrMemoLine2.FINDSET() then
                                repeat
                                    Consignes += SalesCrMemoLine2."Line Amount";
                                until SalesCrMemoLine2.NEXT() = 0;
                            //HEI.01<<
                        end;
            ...
            begin
                ...
                ReturnReceiptHeader.SETRANGE("Return Order No.", "Return Order No.");
                if ReturnReceiptHeader.FINDFIRST() then
                    ReceiptNo := ReturnReceiptHeader."No."
                else
                    ReceiptNo := '';
                ...
                if SalesHeaderArchive.FINDFIRST() then
                    ReturnOrderDate := SalesHeaderArchive."Order Date"
                else begin
                    SalesHeader.SETRANGE("Document Type", SalesHeader."Document Type"::"Return Order");
                    SalesHeader.SETRANGE("No.", "Return Order No.");
                    // BC Upgrade RD03 Drinkit Field Commented .......>>
                    //if SalesHeader.FINDFIRST() then
                    //ReturnOrderDate := SalesHeader."Return Date";
                    // BC Upgrade RD03 Drinkit Field Commented .......<<
                end;
                ...
                // BC Upgrade RD03 Drinkit Field Commented .......>>
                //SalesCrMemoLine2.SETRANGE("Item Charge Type", SalesCrMemoLine2."Item Charge Type"::Tax);
                // BC Upgrade RD03 Drinkit Field Commented .......<<
                if SalesCrMemoLine2.FINDSET() then
                    repeat
                        OtherTax := true;
                        if ((STRPOS(LOWERCASE(SalesCrMemoLine2.Description), 'droit') > 0) and
                           (STRPOS(LOWERCASE(SalesCrMemoLine2.Description), 'accise') > 0))
                        then
                            OtherTax := false;
                        if ((STRPOS(LOWERCASE(SalesCrMemoLine2.Description), 'eco') > 0) and
                           (STRPOS(LOWERCASE(SalesCrMemoLine2.Description), 'emballage') > 0))
                        then
                            OtherTax := false;
                        if ((STRPOS(LOWERCASE(SalesCrMemoLine2.Description), 'octroi') > 0) and
                           (STRPOS(LOWERCASE(SalesCrMemoLine2.Description), 'mer') > 0))
                        then
                            OtherTax := false;
                    until (SalesCrMemoLine2.NEXT() = 0) or OtherTax;
    ...
    labels
    {
        ...
        label(PaymentTextLbl2; ENU = ' / SWIFT',
                              FRA = ' / BIC')
        label(ReceiptNoLbl; ENU = 'Receipt No.',
                           FRA = 'N° retour')
        label(ReturnOrderNoLbl; ENU = 'Return Order No.',
                               FRA = 'N° Ordre de retour')
        label(ReturnOrderDateLbl; ENU = 'Return Order Date',
                                 FRA = 'Date retour')
        label(ReceiptDateLbl; ENU = 'Posting Date',
                             FRA = 'Date avoir')
        ...
        label(TotalTTCLbl; ENU = 'TOTAL TTC',
                          FRA = 'TOTAL TTC')
        label(ConsigneLbl; ENU = 'DECONSIGNE',
                          FRA = 'DECONSIGNE')
        label(NETaPayerEnEURLbl; ENU = 'NET A DEDUIRE EN EUR',
                                FRA = 'NET A DEDUIRE EN EUR')
    ...
    begin
        ...
        if SalesReceivablesSetup.GET then
            if SalesReceivablesSetup."OTC Billing Auto JQ UserID FND" = USERID then
                CurrReport.LANGUAGE := SysLanguage.GetLanguageID('FRA'); // BC Upgrade RD03 Variable name changed From Language to SysLanguage
        //HEI.07<<
        //HEI.01>>
        //Header Image
        // BC Upgrade RD03 Drinkit Related Commented .......>>
        /*StandardTextReport.RESET();
        StandardTextReport.SETRANGE("Report ID", 50397);
        ...
        StandardTextReport2.SETRANGE("Report ID", 50397);
    ...
    var
        ...
        InvoiceNoLbl2: TextConst ENU = 'Credit Memo No.', FRA = 'Avoir N°';
