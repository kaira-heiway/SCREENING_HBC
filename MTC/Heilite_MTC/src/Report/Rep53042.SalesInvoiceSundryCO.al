report 53042 "Sales Invoice - Sundry CO"
{
    // version HEI.10
    ...
    // -------------------------------------------------------------------------------------------------------------------
    // 
    // HEI.14 CHG2105027 HT1226 IBM GAVANM01 12.05.2021 #Sales Documents Brasco
    //   #new report, copied from ID 50278
    //*********************************************//
    //BC UPGRADE ATHUKS01//
    ...
    //5.Old Report ID 50515 
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Sales Invoice - Sundry CO.rdl';

    Caption = 'Sales Invoice - Sundry CO';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
                        ...
                        begin
                            ...
                            if Type <> Type::"Charge (Item)" then begin
                                ...
                                IF (Type = Type::"Charge (Item)") AND ("Item Charge Type" = "Item Charge Type"::Discount) THEN
                                  IF ItemCh.GET("No.") AND NOT ItemCh."Transport/Shipping Cost" AND  //HEI.13
            ...
            begin
                ...
                //CurrReport.LANGUAGE := Language.GetLanguageID("Language Code");  //HEI.14
    ...
    var
        ...
        Text52007: TextConst ENU = 'Sundry Invoice', FRA = 'Facture Diverse';
