report 53041 "Proforma Invoice CO"
{
    // version HEI.08
    ...
    // -------------------------------------------------------------------------------------------------------------------
    // 
    // HEI.12 CHG2105027 HT1226 IBM GAVANM01 12.05.2021 #Sales Documents Brasco
    //   #new report, copied from ID 50279
    //*****************************//
    //BC UPGRADE ATHUKS01//
    //1.Commnented Drink IT Code,Dataitem columns & added as blank value for drink fields.
    //2.Commented CAD related Code. 
    //3.Change Language to LanguageMgt and record to codeunit for getting Language.
    //4.CurrReport.PAGENO is deprecated and unsupported in modern Business Central (AL language) RDLC ,often returning a constant value of 1 or causing compilation warnings.
    //5.Old Report ID 50516
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Proforma Invoice CO.rdl';

    Caption = 'Proforma Invoice CO';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        DataItemTableView = SORTING("Document Type", "Document No.", "Line No.") WHERE(Type = FILTER(Item | Resource | "Fixed Asset" | "Charge (Item)" | "G/L Account"));
                        ...
                        begin
                            ...
                            if Type <> Type::"Charge (Item)" then begin
                                ...
                                IF (Type = Type::"Charge (Item)") AND ("Item Charge Type" = "Item Charge Type"::Discount) THEN
                                  IF ItemCh.GET("No.") AND NOT ItemCh."Transport/Shipping Cost" AND //HEI.11
                    ...
                    begin
                        ...
                        if SalesInvLineAmt.FINDSET() then
                            repeat
                                ...
                                if (SalesInvLineAmt.Type = SalesInvLineAmt.Type::Resource) and SalesSetup."Timbre Electronique FND" and (SalesInvLineAmt."No." = SalesSetup."Timbre Resource Code FND") then begin
                        ...
                        Check.FormatNoText(DescriptionLine, "Sales Header"."Amount Including VAT", CurrencyCode); //HEI.07
            ...
            begin
                //BC UPGRADE ATHUKS01 >>  Drink IT field 
                //-----Language
                //CurrReport.LANGUAGE := Language.GetLanguageID("Language Code");  //HEI.12
                ...
                if CustPostGroup.GET("Sales Header"."Customer Posting Group") then;
                //HEI.12>>
    ...
    labels
    {
        ...
        label(LblDiscTotal; ENU = 'Disc Total:',
                           FRA = 'Remise Totale')
        CustomerServiceEmailLbl = 'Customer Service E-Mail:'; label(LblQtyCrates; ENU = 'Quantity of crates',
    ...
    var
        ...
        Text52006: TextConst ENU = 'Proforma Invoice', FRA = 'Facture Proforma';
        TaxAmout: Decimal;
        VATAmount: Decimal;
        DepAmount: Decimal;
        ShipAmount: Decimal;
