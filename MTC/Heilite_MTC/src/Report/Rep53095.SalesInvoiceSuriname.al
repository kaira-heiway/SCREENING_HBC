report 53095 "Sales Invoice Suriname"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Sales Invoice Suriname.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            // BC Upgrade SHUKLP03 >> Dependency on DIT field Weight >>
                            ...
                            // BC Upgrade SHUKLP03 >> Dependency on DIT fields "Item Charge Type", "Show Item charge on Invoice"
                    ...
                    begin
                        ...
                        // BC Upgrade SHUKLP03 >> DIT field "Item Charge Type"
            ...
            begin
                ...
                // BC Upgrade SHUKLP03 >> Dependency on DIT record StandardTextReport.
                ...
                //                 IF ExtendedTextLine.FINDSET(FALSE, FALSE) THEN BEGIN
                //                     REPEAT
    ...
    var
        ...
        //StandardTextReport: Record "2014410"; // BC Upgrade SHUKLP03 <<
