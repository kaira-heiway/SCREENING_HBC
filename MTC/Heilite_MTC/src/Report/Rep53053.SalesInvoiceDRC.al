report 53053 "Sales Invoice DRC"
{
    // version HEI.01
    ...
    //*********************************************//
    //BC UPGRADE ATHUKS01//
    //1.Old Report ID 50432.
    //2.Commented Drink IT fields & Drink IT Code.
    //3.Change Language to LanguageMgt and record to codeunit for getting Language. 
    //4.CurrReport.PAGENO is deprecated and unsupported in modern Business Central (AL language) RDLC layouts, often returning a constant value of 1 or causing compilation warnings.   

    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Sales Invoice DRC.rdl';

    CaptionML = ENU = 'Sales Invoice DRC',
                FRA = 'Facture Vente DRC';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(TxtDisc1; TxtDisc1)
            {
            }
            column(TxtNoLicense; TxtNoLicense)
            {
            }
            column(CompanyInfo_Currency; CompanyInfo."Currency FND")
            {
            }
            column(CompanyInfo_Currency2; CompanyInfo."Currency 2 FND")
            {
            }
            column(GeneralOpCoSetup_Currency3; GeneralOpCoSetup."Currency 3")
            {
            }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            if "Sales Invoice Line".Type = "Sales Invoice Line".Type::Item then
                                //TotalGrossWeight += "Sales Invoice Line".Weight; //BC UPGRADE ATHUKS01 Drink IT field
                            ...
                            */
                            ...
                            // if SalesChargeLine.FINDSET() then begin
                            //     repeat
                            //         if ItemChargeRec.GET(SalesChargeLine."No.") and not ItemChargeRec."Transport/Shipping Cost" then begin
                            //             IsDiscount := true;
                            ...
                            // SalesChargeLine.SETRANGE("Document No.", "Sales Invoice Line"."Document No.");
                            // SalesChargeLine.SETRANGE(Type, "Sales Invoice Line".Type::"Charge (Item)");
                            // //SalesChargeLine.SETRANGE("Item Charge Type", "Sales Invoice Line"."Item Charge Type"::Deposit);//BC UPGRADE ATHUKS01 >> Drink IT field
                            ...
                            if SalesChargeLine.FINDSET then begin
                                ...
                                repeat
                                    ...
                                    if ItemChargeRec."Shipping Cost BPM FND" then begin//#BCUP0-RTR-BPM Item Charges BC Upgrade KAIRAR01
            ...
            begin
                ...
                // SalesInvLine_1.SETRANGE("Free Item", false);
    ...
    var
        ...
        TxtDisc1: TextConst ENU = 'Disc.', FRA = 'Remise', ENG = 'Disc.';
