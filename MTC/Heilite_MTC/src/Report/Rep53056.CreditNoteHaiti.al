report 53056 "Credit Note Haiti"
{
    // version HEI.08
    ...
    //   # Saved as from Report 50262(Credit Note STD) so kept the old documentation as above under starred line, didn't delete
    ...
    //*********************************************//
    //BC UPGRADE ATHUKS01//
    //1.Old Report ID 50489
    //2.Change Language to LanguageMgt and record to codeunit for getting Language.
    //3.CurrReport.PAGENO is deprecated and unsupported in modern Business Central (AL language) RDLC layouts, often returning a constant value of 1 or causing compilation warnings. 
    //4.Commented Drink-IT Record and related code(StandardTextReport: Record "Standard Text Report")
    //5.Commented out the Drink-IT logic associated with the “Item Charge Type” field.   
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Credit Note Haiti.rdl';

    Caption = 'Credit Note Haiti';
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SalesInvHeader_SellToNo; "Sales Cr.Memo Header"."Sell-to Customer No.")
                    {
                    }
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        begin
                            ...
                            //         repeat
                            //             if ItemCh.GET(SalesInvoiceLine."No.") and not ItemCh."Transport/Shipping Cost" then begin  //HEI.11
                            ...
                            *///HEI.07<<
                            ...
                            //var_Dis := "Line Discount Amount"; //HEI.09 HEI.12 commented
                            var_Dis := "Line Discount %"; //HEI.12
                            //BC UPGRADE ATHUKS01 >> Drink IT
                            ...
                            //                                                 //var_Dis += "Line Amount"; //HEI.09 //HEI.12 commented
                            //             var_Dis += ABS("Item Charge Value"); //HEI.12
                            //BC UPGRADE ATHUKS01 << Drink IT
                    ...
                    begin
                        ...
                        //                 //IF ItemCh.GET(SalesInvLine."No.") AND ItemCh."Hide Item charge on printout" THEN //HEI.12  //commented by HEI.13
                        ...
                        //                                                                     //IF (ItemCh.GET(SalesInvLine."No.")) AND (ItemCh."Hide Item charge on printout" = FALSE) THEN BEGIN //HEI.16  //commented by HEI.13
                        ...
                        // if SalesInvLine.FINDSET then
                        //     repeat
                        //         //IF ItemCh.GET(SalesInvLine."No.") AND NOT ItemCh."Hide Item charge on printout" THEN BEGIN //HEI.16  //commented by HEI.13
            ...
            begin
                ...
                //BC UPGRADE ATHUKS01>>Drink IT Report.
                //-----Footer Texts
                // CLEAR(CurrReportID);
                // CLEAR(i);
                // CLEAR(TextFooter);
