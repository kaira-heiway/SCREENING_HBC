report 53047 "Customer Stmt. of Account HT"
{
    // version HEI.01
    ...
    //*****************************************//
    //BC UPGRADE ATHUKS01// 
    // 1. Old Report ID - 50475.
    // 2. Add ApplicationArea and UsageCategory property in report and requestpage fields.
    // 3. Remove Drink-IT Fields in Dataset columns("Tax Registration No.","Item Charge Type").
    ...
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Customer Stmt. of Account HT.rdl';

    CaptionML = ENU = 'Customer Statement of Account Haiti',
                FRA = 'Client – relevé de compte Haiti';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            // column(CompanyTaxNo_Customer; Customer."Tax Registration No.")
            // {
            // }
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                // column(ItemChargeType_CustLedgerEntry; "Cust. Ledger Entry"."Item Charge Type")
                // {
                // }
    ...
    begin
        ...
        //BC UPGRADE ATHUKS01 >>
        // if LanguageR.GetLanguageCode() = 'FRA' then
        //     EVALUATE(PeriodLength, '30J')
        // else if LanguageR.GetUserLanguage() = 'ENU' then
        //     EVALUATE(PeriodLength, '30D');

        if GlobalLanguage() = 1036 then // French
            EVALUATE(PeriodLength, '30J')
        else
            if GlobalLanguage() = 1033 then // English (US)
                EVALUATE(PeriodLength, '30D');
        //BC UPGRADE ATHUKS01 <<        
