report 53079 "Proforma Invoice La Reunion"
{
    // version HEI.07
    ...
    // BC Upgrade BHARDA11 >>
    // 1. OLD Report ID - 50323.
    // 2. Add layout path and change layout extension RDLC to RDL.
    // 3. Remove Drink-IT Field and related code("Item Charge Type" and "Show Item charge on Invoice" and "Free Item" and "Document Subtype Code" and "ItemCharge Incl. Price")
    // 4. Remove Drink-IT  Record variables and related code( "Document Subtype Code Setup FND" and "Standard Text Report")
    // 5. Change "Item Cross Reference" to "Item Reference".
    // BC Upgrade BHARDA11 <<
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Proforma Invoice La Reunion.rdl';

    Caption = 'Proforma Invoice La Reunion';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            // column(Header_Image; StandardTextReport.Image) // BC Upgrade BHARDA11 -----Drink-IT Table Field
            column(Header_Image; '')
            {
            }
            ...
            // column(SalesHeader_OrderNo; "Order No.") // BC Upgrade BHARDA11 ----Drink-IT Field("Order No.")
            column(SalesHeader_OrderNo; '')
            {
            }
            column(SalesHeader_OrderDate; "Shipment Date")
            {
            }
            column(SalesHeader_ShipmentDate; "Order Date")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        var
                            // ItemCrossReference: Record "Item Cross Reference"; // BC Upgrade BHARDA11 ----Item Cross Reference is Obsolete.
                        ...
                        begin
                            ...
                            if Type = Type::Item then begin
                                ...
                                if ItemCrossReference.FINDFIRST then
                                    ...
                                    OctroiGtin := ItemCrossReference."Reference No."; // BC Upgrade BHARDA11 ::BloAddedcked
                                if OctroiGtin <> '' then
                            ...
                            if Type = Type::Item then begin
                                ...
                                // ChargeInvoiceLine.SETRANGE("Item Charge Type", ChargeInvoiceLine."Item Charge Type"::Discount); // BC Upgrade BHARDA11 -----Drink_IT Field("Item Charge Type")
                            ...
                            if Type = Type::Item then begin
                                ...
                                // ChargeInvoiceLine2.SETRANGE("Item Charge Type", ChargeInvoiceLine2."Item Charge Type"::Discount); // BC Upgrade BHARDA11 -----Drink_IT Field("Item Charge Type")
                            ...
                            ChargeInvoiceLine2.SETRANGE("Attached to Line No.", "Line No.");
                            // ChargeInvoiceLine2.SETFILTER("Show Item charge on Invoice", '<>%1', ChargeInvoiceLine2."Show Item charge on Invoice"::"Include in item price"); // BC Upgrade BHARDA11 ----Drink-IT Field("Show Item charge on Invoice")
                            // ChargeInvoiceLine2.SETRANGE("Item Charge Type", ChargeInvoiceLine2."Item Charge Type"::Tax); // BC Upgrade BHARDA11 -----Drink_IT Field("Item Charge Type")
                            if ChargeInvoiceLine2.FINDSET then
                                repeat
                            ...
                            if Type = Type::Item then begin
                                ...
                                ChargeInvoiceLine2.SETRANGE(Type, ChargeInvoiceLine2.Type::"Charge (Item)");
                                ChargeInvoiceLine2.SETRANGE("Attached to Line No.", "Line No.");
                                // ChargeInvoiceLine2.SETFILTER("Item Charge Type", '%1|%2', ChargeInvoiceLine2."Item Charge Type"::Discount, ChargeInvoiceLine2."Item Charge Type"::Tax); // BC Upgrade BHARDA11 -----Drink_IT Field("Item Charge Type")
                                if ChargeInvoiceLine2.FINDSET then
                                    repeat
                            ...
                            if Type = Type::Item then begin
                                ...
                                ChargeInvoiceLine2.SETRANGE(Type, ChargeInvoiceLine2.Type::"Charge (Item)");
                                ChargeInvoiceLine2.SETRANGE("Attached to Line No.", "Line No.");
                                // ChargeInvoiceLine2.SETRANGE("Item Charge Type", ChargeInvoiceLine2."Item Charge Type"::Deposit); // BC Upgrade BHARDA11 -----Drink_IT Field("Item Charge Type")
                    ...
                    dataitem(Totals; "Integer")
                    {
                        ...
                        begin
                            ...
                            // SalesLine2.SETFILTER("Item Charge Type", '<>%1', SalesLine2."Item Charge Type"::Deposit);// BC Upgrade BHARDA11 -----Drink_IT Field("Item Charge Type")
                            ...
                            Consignes := 0;
                            SalesLine2.SETRANGE("Document No.", "Sales Header"."No.");
                            // SalesLine2.SETRANGE("Item Charge Type", SalesLine2."Item Charge Type"::Deposit); // BC Upgrade BHARDA11 -----Drink_IT Field("Item Charge Type")
                            if SalesLine2.FINDSET then
                                repeat
            ...
            var
                ...
                LegalFormName: Text;
            begin
                DocSubtypeCodeSetup.GET(); // BC Upgrade SHUKLP03 (DocSubtypeCodeSetup)
                //HEI.03>>
                ...
                //     ExportInvoice := FALSE;
                //HEI.03<<
                // BC Upgrade SHUKLP03 >>("Document Subtype Code",DocSubtypeCodeSetup)
                ...
                // SalesLine2.SETRANGE("Item Charge Type", SalesLine2."Item Charge Type"::Tax); // BC Upgrade BHARDA11 ----Drink-IT Field("Item Charge Type")
                if SalesLine2.FINDSET then
                    repeat
                        OtherTax := true;
    ...
    labels
    {
        ...
        label(ShipmentDateLbl; ENU = 'Order Date',
                              FRA = 'Date Facture')
    ...
    begin
        ...
        //HEI.01>>
        //Header Image
        // BC Upgrade BHARDA11 >> ----Drink-IT Table records(StandardTextReport, StandardTextReport2)
        // StandardTextReport.RESET;
        // StandardTextReport.SETRANGE("Report ID", 50323);
        ...
        // StandardTextReport2.SETRANGE("Report ID", 50323);
    ...
    var
        ...
        // BC Upgrade BHARDA11 >> ----Drink-IT Table records( "Standard Text Report")
        ...
        InvoiceNoLbl2: TextConst ENU = 'Proforma Invoice No.', FRA = 'Facture Proforma N°';
