report 53049 "Debit Note CO"
{
    ...
    // -------------------------------------------------------------------------------------------------------------------
    // 
    // HEI.03 CHG2105027 HT1226 IBM GAVANM01 12.05.2021 #Sales Documents Brasco
    //   #new report, copied from ID 50454
    //*************************************//
    //BC UPGRADE ATHUKS01//
    //1.Old Report ID 50517.
    ...
    // 7. Corrected Sales Invoice Line DataItemTableView filter expression for Type values.
    //     where(Type = filter(Item | Resource | "Fixed Asset" | "Charge (Item)"));

    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Debit Note CO.rdlc';

    Caption = 'Debit Note CO';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            if "Sales Invoice Line".Type = "Sales Invoice Line".Type::Item then begin
                                //TotalGrossWeight += "Sales Invoice Line".Weight; //BC UPGRADE ATHUKS01 -Drink IT
                            ...
                            IF (Type = Type::"Charge (Item)") AND ("Item Charge Type" = "Item Charge Type"::Discount) THEN
                              IF ItemCh.GET("No.") AND NOT ItemCh."Transport/Shipping Cost" AND  //HEI.02
                ...
                begin
                    if Number > 1 then
                        CopyText := Text52000;
                    //CurrReport.PAGENO := 1; //BC UPGRADE ATHUKS01 - Drink IT
                    OutputNo := OutputNo + 1;
            ...
            begin
                ...
                //               (ItemCh.GET(SalesInvLine."No.") and ((SalesInvLine."Item Charge Type" in [SalesInvLine."Item Charge Type"::Discount, SalesInvLine."Item Charge Type"::" "]) or ItemCh."Excise Duties" or ItemCh."Transport/Shipping Cost")) then
    ...
    labels
    {
        ...
        label(lblOrderNo; ENU = 'SO Order No:',
                         FRA = 'N° de Commande',
                         ENG = 'SO Order No:')
        label(lblInvoiceNo; ENU = 'Debit Note No:',
                           FRA = 'N° de Facture')
        label(lblVATAmt; ENU = 'Total VAT:',
                        FRA = 'TVA Produits')
        label(lblPostDate; ENU = 'Debit Note Date:',
        ...
        label(LblCustomerNo; ENU = 'Customer No:',
                            FRA = 'N° du client')
        label(LblInvoiceCurrency; ENU = 'Debit Note Currency:',
        ...
        label(LblInvoiceCurrLCY; ENU = 'Debit Note Curr LCY:',
                                FRA = 'Devise de facturation')
    ...
    begin
        ...
        // GeneralOpCoSetup.GET(); siva need to remove
    ...
    var
        ...
        Text52006: TextConst ENU = 'Debit Note', FRA = 'Note de Débit';
        TaxAmout: Decimal;
        VATAmount: Decimal;
        DepAmount: Decimal;
        ShipAmount: Decimal;
        ...
        TxtInvoiceNo: TextConst ENU = 'Debit Note No:', FRA = 'N° de Facture';
        TxtVATAmt: TextConst ENU = 'Total VAT:', FRA = 'TVA Produits';
        TxtPostDate: TextConst ENU = 'Debit Note Date:', FRA = 'Date de facturation';
        ...
        TxtDeposit: TextConst ENU = 'Deposit Value', FRA = 'Valeur Emballage';
        TxtDepositVAT: TextConst ENU = 'Deposit VAT', FRA = 'TVA Emballage';
        TxtDepositCAD: TextConst ENU = 'CAD Deposit', FRA = 'Cent. Addit. Emballage';
