report 53094 "Sales invoice Bahamas"
{
    ...
    // BC Upgrade SHUKLP03 >> 
    // Created Report because not found in Txt2AL folder.
    // Blocked code because dependency on DIT fields "Item Charge Type", "Show Item charge on Invoice", weight and free item
    // BC Upgrade SHUKLP03 <<

    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Sales invoice Bahamas.rdlc';

    Caption = 'Sales Invoice Bahamas';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            // BC Upgrade SHUKLP03 >> Dependency on DIT fields
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            // BC Upgrade SHUKLP03 >> Blocked because dependency on DIT field "Sales Invoice Line".Weight.
                            ...
                            // BC Upgrade SHUKLP03 >> Blocked because dependency on DIT fields "Item Charge Type","Show Item charge on Invoice"
                            ...
                            //         REPEAT
                            //             IF ItemCh.GET(SalesInvoiceLine."No.") AND NOT ItemCh."Transport/Shipping Cost" THEN BEGIN
                            ...
                            //         IF ItemCh.GET("No.") AND NOT ItemCh."Transport/Shipping Cost" THEN
                            //             CurrReport.SKIP;
                            // BC Upgrade SHUKLP03 << Blocked because dependency on DIT fields "Item Charge Type","Show Item charge on Invoice".
                            ...
                            ItemDiscount := 0;
                            itemDeposit := 0;
                            // BC Upgrade SHUKLP03 >> Blocked because dependency on DIT field "Free Item".
                    ...
                    begin
                        ...
                        // BC Upgrade SHKLP03 >> Dependency on DIT "Item Charge Type" field.
            ...
            begin
                ...
                // BC Upgrade SHUKLP03 >> DIT Table StandardTextReport.
                //-----Footer Texts
                // CLEAR(CurrReportID);
                // CLEAR(i);
                // CLEAR(TextFooter);
                ...
                // IF StandardTextReport.FINDSET(FALSE,FALSE) THEN
                //   REPEAT
                //     i := 1;
                ...
                //     IF ExtendedTextHeader.FINDSET(FALSE,FALSE) THEN BEGIN
                //       REPEAT
                ...
                //         IF ExtendedTextLine.FINDSET(FALSE,FALSE) THEN
                //         BEGIN
                //           REPEAT
    ...
    var
        ...
        CountryInfo: Record "Company Information";
        lineNumberVAT: Integer;
        InvDisAmount: Decimal;
        UnitPrice: Decimal;
        LineAmount: Decimal;
        DiscIncluded: Decimal;
        //StandardTextReport: Record "2014410"; // BC Upgrade SHUKLP03 << DIT Table
