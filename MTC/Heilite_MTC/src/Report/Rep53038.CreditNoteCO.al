report 53038 "Credit Note CO"
{
    ...
    //   #new report, copied from ID 50262
    //*********************************************//
    //BC UPGRADE ATHUKS01//
    //1.HEI.04,HEI.05,HEI.06 No changes
    //2.HEI.07 Commented drink IT code.
    //3.HEI.09,HEI.10,HEI.11,HEI.12 Commented drink IT code.
    ...
    //6.Old Report ID 50512  
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Credit Note CO.rdl';

    Caption = 'Credit Note CO';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
                    ...
                    begin
                        ...
                        if SalesInvLine.FINDSET() then
                            repeat
                                ...
                                //BC UPGRADE ATHUKS01 >>  Drink IT field 
                                //     case 
                                //         SalesInvLine."Item Charge Type" of
                                ...
                                Check.FormatNoText(DescriptionLine, "Sales Cr.Memo Header"."Amount Including VAT", CurrencyCode);
            ...
            begin
                ...
                if CustPostGroup.GET("Sales Cr.Memo Header"."Customer Posting Group") then;
                //HEI.12>>
    ...
    var
        ...
        TxtOrderNo: TextConst ENU = 'RO Order No:', FRA = 'N° de Commande';
        TxtInvoiceNo: TextConst ENU = 'Credit Note No:', FRA = 'N° de Facture';
        TxtVATAmt: TextConst ENU = 'Total VAT:', FRA = 'TVA Produits';
        TxtPostDate: TextConst ENU = 'Credit memo Date:', FRA = 'Date de facturation';
        ...
        TxtInvoiceCurrLCY: TextConst ENU = 'Credit No Curr LCY:', FRA = 'Devise de facturation';
