report 53012 "Sales Invoice - Export STD"
{
    // version HEI.06
    ...
    // 3. Commented out unused Bank Details 2 columns (Bank Name 2, Bank Account No. 2, IBAN 2, SWIFT Code 2).
    //    Old: Layout dataset was using CompanyInfo Bank Details 2 fields.
    //    New: Columns commented as fields are not available in current BC base table.
    // 4. Commented out old Item Charge related filters/conditions due to field incompatibility in upgraded BC.
    //    Old: Using fields like "Item Charge Type" and "Show Item charge on Invoice" in filters and logic.
    //    New: Those conditions and filters commented out because these fields are not available / DIT field in upgraded BC.
    // 5. Replaced deprecated language handling with Codeunit Language.
    ...
    // 6. Added ApplicationArea = All on Request Page field "No. of Copies" for BC compliance.
    //    Old: Request page field missing ApplicationArea.
    //    New: ApplicationArea = All added on field "No. of Copies".
    // 7. Commented out Standard Text Report functionality due to missing variable/table in upgraded BC.
    //    Old: StandardTextReport: Record "Standard Text Report" used to fetch footer text from Extended Text.
    //    New: StandardTextReport variable and related logic commented as object/variable missing in BC upgraded base.
    // 8. Commented out Tax Registration No. display in CompanyText due to field mismatch.
    //    Old: CompanyInfo."Tax Registration No." used in CompanyText.
    //    New: Blocked as field not available/compatible in upgraded BC base.
    ...
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Sales Invoice - Export STD.rdl';
    ...
    Caption = 'Sales Invoice - Export STD';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            if Type <> Type::"Charge (Item)" then begin
                                ...
                                // SalesInvoiceLine.SETRANGE("Item Charge Type", SalesInvoiceLine."Item Charge Type"::Discount); // BC Upgrade RAHUL Due to DIT Field
                                // SalesInvoiceLine.SETRANGE("Show Item charge on Invoice", SalesInvoiceLine."Show Item charge on Invoice"::"Include in item price"); // BC Upgrade RAHUL Due to DIT Field
                            ...
                            //  else if ("Item Charge Type" <> "Item Charge Type"::Discount) or
                            ...
                            if "Sales Invoice Line".Type = "Sales Invoice Line".Type::Item then begin
                                // TotalGrossWeight += "Sales Invoice Line".Weight;  // BC Upgrade RAHUL Blocking Else condtion Due to DIT Field
                    ...
                    begin
                        ...
                        if SalesInvLineAmt.FINDSET() then
                            repeat
                                // if (SalesInvLineAmt.Type <> SalesInvLineAmt.Type::"Charge (Item)") or (SalesInvLineAmt."Item Charge Type" = SalesInvLineAmt."Item Charge Type"::" ") then  //HEI.09  // BC Upgrade RAHUL Blocking Else condtion Due to DIT Field
                        ...
                        Check.FormatNoText(DescriptionLine, "Sales Invoice Header"."Amount Including VAT", "Sales Invoice Header"."Currency Code"); //HEI.05
            ...
            begin
                ...
                //BC Upgrade RAHUL Due to DIT Field >>
    ...
    var
        ...
        // StandardTextReport: Record "Standard Text Report"; //BC Upgrade RAHUL Blocking As Variable Missing.
        ...
        Text52007: Label 'Export Invoice';
