report 53066 "Send SEM Sales Documents"
{
    // version HEI.01
    ...
    trigger OnPreReport();
    begin
        //BC UPGRDAE KUMARR78>> Variable Removed("SEM Interface Mgmt.")
    ...
    var
        // SEMInterfaceMgmt: Codeunit "SEM Interface Mgmt."; //BC UPGRDAE KUMARR78 Variable Removed
