pageextension 53030 PostedSalesInvoiceLinesExt extends "Posted Sales Invoice Lines"
{
    ...
    //Bc Upgrade YADAVM09 "Maraki Fiscal No" added in interface extension.
    layout
    {
        ...
        {
            ToolTipML = ENU = 'Specifies the customer that the invoice was sent to.', FRA = 'Spécifie le client auquel la facture a été envoyée.';
    ...
    var
        TempRecOpenFilters: Record "Sales Invoice Line" temporary;
        IsOpenPage: Boolean;
