page 53022 "Sundry Sales Order Non Stock"
{
    // version HEI.01
    //BC UPGRADE SIVA Old Page ID 50153
    ...
    Caption = 'Sundry Sales Order Non Stock';
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Sell-to Address"; rec."Sell-to Address")
                {
                    ...
                    ToolTip = 'Specifies the Sell-to Address of the address.';
                    Visible = false;
                }
                field("Sell-to Address 2"; rec."Sell-to Address 2")
                {
                    ToolTip = 'Specifies the Sell-to Address 2 of the address.';
                    Visible = false;
                }
                ...
                {
                    ToolTip = 'Specifies the Sell-to City of the address.';
                    Visible = false;
                }
    ...
    begin
        ...
        if docsubtypecodesetup.GET() then begin
            docsubtypecodesetup.TESTFIELD(docsubtypecodesetup."Sundry Sales Order Non Stock");
            Rec.FILTERGROUP(2);
            Rec.SETRANGE("Document Subtype Code FND", docsubtypecodesetup."Sundry Sales Order Non Stock");
            Rec.FILTERGROUP(0);
        end;
        //PATHAA02<<
        //BC UPGRADE SIVA <<
    ...
    begin
        //if ApplicationAreaSetup.IsFoundationEnabled then //BC UPGRADE SIVA Microsoft Removeal
