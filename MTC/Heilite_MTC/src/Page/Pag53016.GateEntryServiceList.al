page 53016 "Gate Entry Services List"
{
    // version HEI.03
    //BC Upgrade GUNREM01 old page ID-50235
    ...
    CaptionML = ENU = 'Gate Entry Services',
                FRA = 'Gate Entry Services';
    CardPageID = "Gate Entry Service";
    Editable = false;
    PageType = List;
    SourceTable = "Gate Entry Header FND";
    SourceTableView = SORTING("Gate Entry Document No.")
                      WHERE("Gate Entry Type" = FILTER(Service),
