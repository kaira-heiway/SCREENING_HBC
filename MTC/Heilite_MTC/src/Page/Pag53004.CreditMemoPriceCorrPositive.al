page 53004 "CreditMemo PriceCorr(Positive)"
{
    // version HEI.01
    //BC UPGRADE SIVA Old Page ID 50135  
    ...
    Caption = 'CreditMemoPriceCorr(Positive)';
    ApplicationArea = all;
            ...
            group("&Invoice")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordFilters(DATABASE::"Sales Header", Rec."Document Type", REc."No.");//BC UPGRADE SIVA Use SetRecordFilters instead of SetFilters
                        ApprovalEntries.RUN();
                    end;
                }
                action(Customer)
    ...
    begin
        ...
        if docsubtypecodesetup.GET() then begin
            docsubtypecodesetup.TESTFIELD("CreditMemo-PriceCorr(Positive)");
            Rec.FILTERGROUP(2);
            Rec.SETRANGE("Document Subtype Code FND", docsubtypecodesetup."CreditMemo-PriceCorr(Positive)");
            Rec.FILTERGROUP(0);
            //PATHAA02<<
        end;
        //BC UPGRADE SHUKLP03 << Added code
    ...
    begin
        //if DummyApplicationAreaSetup.IsFoundationEnabled then begin //BC UPGRADE SIVA
        LinesInstructionMgt.SalesCheckAllLinesHaveQuantityAssigned(Rec);
        ...
        //if DummyApplicationAreaSetup.IsFoundationEnabled then //BC UPGRADE SIVA 
