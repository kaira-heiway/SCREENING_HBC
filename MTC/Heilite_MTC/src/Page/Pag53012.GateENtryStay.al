page 53012 "Gate Entry Stay"
{
    // version HEI.04
    //BC Upgrade GUNREm01 -Old page ID 50227
    ...
    SourceTableView = WHERE("Gate Entry Type" = FILTER(Stay),
    ...
    begin
        Rec."Gate Entry Type" := Rec."Gate Entry Type"::Stay;
