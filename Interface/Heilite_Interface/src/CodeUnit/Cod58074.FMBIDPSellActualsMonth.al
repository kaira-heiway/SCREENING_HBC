codeunit 58074 "FM BI - DP Sell Actuals Month"
{
    //BC Upgrade GUNREM01 Old ID-50170
    // version FM

    // HEI.01 CHG2102974 IBM GAVANM01 07.05.2021 # Deploy S&OP interfaces to Burundi
    //   #DP Sell in Actuals Month
    //   #DP Sell in Actuals Month 3 Years
    ...
    begin
        //HEI.01<<
        CreateSellInActualsMonth(gILE, true);
        CreateSellInActualsMonth3YR(gILE, true);
        //HEI.01>>
    end;
