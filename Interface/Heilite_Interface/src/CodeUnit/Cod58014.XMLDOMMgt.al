codeunit 58014 "XML DOM Mgt."
{
    ...
    // New Function added
    procedure AddElementText_BC(var pXMLNode: XmlNode; pNodeName: Text; pNodeText: Text; pNameSpace: Text; var pCreatedNode: XmlNode): XmlNode
    var
        lNewChildNode: XmlNode;
    begin
        if pNodeText <> '' then
