table 58034 "Interface Entry Line VIP INT"
{
    // Heilite Navision Old Id - 50162
    // version HEI.23
    ...
    //   # New Fields created: 632 - External ID
    ...
    // 
    // 
    // HEI.12 CHG2128694 IBM NANDIS01     20.02.2022
    //   # Created New Fields: 119 - Best Before Date
    ...
    // HEI.23 CHG2278614 SHARMP16 09.12.2024 Zycus HL integration -GL Rule Map-Development finetuning
    //   # Created New Field: 651 - Account Type

    Caption = 'Interface Entry Line VIP';
    ...
    fields
    {
        field(1; "Header Entry No."; Integer)
        {
            ...
            NotBlank = true;
            TableRelation = "Interface Entry Header VIP INT";
        }
        ...
        {
            CalcFormula = Lookup("Interface Entry Header VIP INT"."Sync. Date" WHERE("Entry No." = FIELD("Header Entry No.")));
        ...
        {
            CalcFormula = Lookup("Interface Entry Header VIP INT"."Source Type" WHERE("Entry No." = FIELD("Header Entry No.")));
            Caption = 'Source Type';
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Lookup("Interface Entry Header VIP INT"."Source No." WHERE("Entry No." = FIELD("Header Entry No.")));
            Caption = 'Source No.';
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Lookup("Interface Entry Header VIP INT"."Source Status" WHERE("Entry No." = FIELD("Header Entry No.")));
    ...
    procedure ShowNotes();
    var
        //TempBlob : Record TempBlob;  // BC Upgrade NANDIS03 - Blocked Tempblob variable is obsolete
