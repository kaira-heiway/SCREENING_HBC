pageextension 58027 PostedPurchRcptSubformExtINT extends "Posted Purchase Rcpt. Subform"
{
    ...
    layout
    {
        ...
        //         IF (PurchRcptHeader."SRM Order No." <> '') AND (rec.Type = rec.Type::"Fixed Asset") THEN
        //             ERROR(UndoFASRMError);
        //         //HEI.03<<
        //     end;//BCUPG not valid trigger
