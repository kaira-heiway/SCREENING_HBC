page 58128 "Leg FM Error Interface Entries"
{
    // version HEI.01

    // HEI.01 FDD-HT610 IBM NASTAA02 06.03.2020 # La Reunion Futur Master
    //   # New Page created to store Legacy FuturMaster Interface Error
    ...
    ApplicationArea = All;
    UsageCategory = Lists;
    Caption = 'FM Error Interface Entries';
    Editable = false;
    PageType = List;
    SourceTable = "Interface Entry Header INT";
    SourceTableView = SORTING(Direction, Status)
                      WHERE(Status = CONST(Error),
                            "Interface Code" = FILTER('LEG-FM-CLMASTER-REQ' | 'LEG-FM-CLMASTER-RES' | 'LEG-FM-CUST-DISC-REQ' | 'LEG-FM-DAILYEXP-REQ' | 'LEG-FM-DAILYEXP-RES' | 'LEG-FM-DRPSTOCK-REQ' | 'LEG-FM-DRPSTOCK-RES' | 'LEG-FM-GLPROD-REQ' | 'LEG-FM-GLPROD-RES' | 'LEG-FM-MONTHLEXP-REQ' | 'LEG-FM-MONTHLEXP-RES' | 'LEG-FM-MPSSTOCK-REQ' | 'LEG-FM-MPSSTOCK-RES' | 'LEG-FM-MRPSTOCK-REQ' | 'LEG-FM-MRPSTOCK-RES' | 'LEG-FM-PO-REQ' | 'LEG-FM-PO-RES' | 'LEG-FM-WEEKLYEXP-REQ' | 'LEG-FM-WEEKLYEXP-RES'));
