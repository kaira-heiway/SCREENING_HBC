page 58141 "Monitor Inbound Interf Entries"
{
    // version HEI.01
    ...
    // BC Upgrade KUMARR78 >>
    //
    // Page Name  : Monitor Inbound Interf Entries
    // Page ID    : 50405
    //
    ...
    //         - Ensures page visibility in BC SaaS environment.
    //
    // 2. Ensured Rec. usage for all field references.
    //    Old:
    //         - Direct field binding without explicit Rec. reference (NAV pattern).
    //    New:
    //         - All fields explicitly referenced using Rec."Field Name".
    //         - Aligns with AL best practices and avoids ambiguity.
    //
    // 3. Replaced old NAV Page IDs with named page references.
    //    Old:
    ...
    //         - Ensures SaaS-safe object referencing and avoids hardcoded legacy IDs.
    //
    // 4. Standardized method calls using Rec.
    //    Old:
    //         - ShowNotes;
    //         - ShowXmlDocument;
    //         - ProcessManually;
    ...
    //         - Rec.ShowXmlDocument();
    //         - Rec.ProcessManually();
    //         - Explicit record context ensures AL compilation compliance.
    //
    // 5. Updated SourceTableView syntax for AL.
    //    Old:
    //         - NAV sorting/where formatting style.
    //    New:
    //         - sorting(Direction, Status)
    //           where(Direction = const(Inbound),
    //                 Status = filter(Pending | Processed));
    //         - AL-compliant filter syntax retained.
    //
    // 6. Updated variable declaration to use object name instead of ID.
    //    Old:
    //         - InterfaceSetup: Record 50000;
    //    New:
    //         - InterfaceSetup: Record "Interface Setup INT";
    //         - Prevents dependency on numeric object IDs in SaaS.
    //
    // BC Upgrade KUMARR78 <<

    Caption = 'Monitor Inbound Interface Entries';
    Editable = false;
        ...
        area(Processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Manual Master Data")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    // RunObject = page 50088; BC UPGRDAE KUMARR78 Blocking As old NAV Page ID.
                    RunObject = page "Interface Manual Master Data"; //BC UPGRDAE KUMARR78 Replacing old NAV Page ID with Variable("Interface Manual Master Data").
                ...
                action("Manual Entries")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    // RunObject = page 50090; BC UPGRDAE KUMARR78 Blocking As old NAV Page ID.
                    RunObject = page "Manual Interface Entries";//BC UPGRDAE KUMARR78 Replacing old NAV Page ID with Variable("Manual Interface Entries")
