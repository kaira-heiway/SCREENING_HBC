page 58094 "Interface Entry Components"
{
    //BC Upgrade VAMSIU01<< Navision Old Id - 50010

    // version HEI.01

    // HEI.01 FDD-GAPID001 IBM LAZARE02 20.06.2017 # New page for Interface Common Framework

    //BC Upgrade VAMSIU01 - added Rec to all the fields in Layout and 

    Caption = 'Interface Entry Components';
    Editable = false;
    PageType = List;
    SourceTable = "Interface Entry Component INT";
        ...
        area(processing)
        {
            group(Component)
            {
                ...
                action(Details)
                {
                    ...
                    PromotedIsBig = true;
                    RunObject = Page "Interface Entry Comp. Details";
