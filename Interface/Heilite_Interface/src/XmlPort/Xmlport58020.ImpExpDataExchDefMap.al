xmlport 58020 "Imp/Exp Data Exch Def & Map"
{
    // HEI.01 FDD-GAPID001 IBM LAZARE02 20.08.2017
    //   # Add Interfaces in DataExchDef
    //   # Add MinOccurs and MaxOccurs in DataExchLineDef

    //#BC Upgrade RD03 - 
    // 1. Custom fields and Noded removed in NAV, so converted CAL to AL and created new object in BC
    // 2. Fixed all the syntax issues
    // 3. LinkField property expersions changed
    // 4. tableelement updated
    ...
    schema
    {
        textelement(root)
        {
            tableelement("Data Exch. Def"; "Data Exch. Def")
            {
                ...
                fieldattribute(Interfaces; "Data Exch. Def"."Interfaces FND")
                {
                }
                tableelement("Data Exch. Line Def"; "Data Exch. Line Def")
                {
                    ...
                    fieldattribute(MinOccurs; "Data Exch. Line Def"."Min. Occurs FND")
                    {
                    }
                    fieldattribute(MaxOccurs; "Data Exch. Line Def"."Max. Occurs FND")
                    {
                    }
                    tableelement("Data Exch. Column Def"; "Data Exch. Column Def")
                    {
                        LinkFields = "Data Exch. Def Code" = FIELD("Data Exch. Def Code"),
                            ...
                            textattribute(TransformationRule)
                            {
                                ...
                                begin
                                    CASE TransformationRule OF
                                        ...
                                        ELSE
                                            "Data Exch. Field Mapping".VALIDATE("Transformation Rule", TransformationRule);
                                    END;
                                end;
                            }
                        }
