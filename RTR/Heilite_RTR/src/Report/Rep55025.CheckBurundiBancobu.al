report 55025 "Check Burundi Bancobu"
{
    ...
    // BC Upgrade SHUKLP03 >> Nav old id - 50381

    DefaultLayout = RDLC;
    RDLCLayout = '.\src\Reportslayout\Check Burundi Bancobu.rdl';

    Caption = 'Check Burundi Bancobu';
