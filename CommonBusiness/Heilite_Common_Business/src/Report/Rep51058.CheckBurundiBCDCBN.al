report 51058 "Check Burundi BCD CBN"
{
    ...
    //***********************************************
    //BC UPGRADE PATHAA02- 19Dec25
    //No errors found


    DefaultLayout = RDLC;
    //RDLCLayout = '.\src\Check Burundi BCD.rdl';//BC UPGRADE PATHAA02
    RDLCLayout = '.\src\Reportslayout\Check Burundi BCD.rdl';//BC UPGRADE PATHAA02

    Caption = 'Check Burundi BCD';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Journal Template Name", "Journal Batch Name", "Posting Date", "Document No.");
            column(CurrencyCode; Genledgersetup."LCY Code")
            {
            }
    ...
    begin
        ...
        GenJnlLine3.SETFILTER("Parent Line No. FND", '=%1', 0);
    ...
    begin
        ...
        if entiere > 1 then
            strprix := strprix + '   ' + Genledgersetup."LCY Code";
        if entiere = 1 then
