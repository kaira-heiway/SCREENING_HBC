report 51035 "Check BA_BNS CBN"
{
    ...
    // 
    // HEI.02 FDD CHG2037399 IBM NANDIS01 17.03.2020 - Cheque Printing
    //   # Code blocked as BNS and FCIB report are now different
    //   # 50237 for Bahamas-BNS and 50258 for Bahamas-FCIB
    //   # Commented code based on CHG2040699(Ref. :- Report 50281)
    //************************************************//
    //BC UPGRADE SIVA //
    //1.HEI.01 No Changes.
    //2.HEI.02 No changes.
    //3 The WITH function has been deprecated in Business Central; the code has been updated accordingly.
    //3.Old Report ID 50237.
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Check BA_BNS.rdl';
    Caption = 'Check BA_BNS';
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    begin
                        if not TestPrint then begin
                            ...
                            //with GenJnlLine do begin //BC UPGRADE ATHUKS01
                                CheckLedgEntry.INIT();
                        CheckLedgEntry."Bank Account No." := BankAcc2."No.";
                        CheckLedgEntry."Posting Date" := GenJnlLine."Posting Date";
                        CheckLedgEntry."Document No." := UseCheckNo;
    ...
    var
        ...
        StoreHNKBnkAcc: Code[20];
        grec_genJnlLn: Record "Gen. Journal Line";
        ConvertLnIntgr: Integer;
        ConvertTreeIntgr: Integer;
        ConvertParentLnIntgr: Integer;
