report 51020 "Realized Production Export CBN"
{
    // version HEI.01
    ...
    requestpage
    {
        ...
        begin
            ...
            if Filename = '' then
                Filename := 'RealizedProduction_' + Format(Year) + '_W' + Format(Week) + '.txt';
            // BC Upgrade BHARDA11 <<
        end;
    }
    ...
    begin
        ...
        //EndingDate := CALCDATE('<-1D>',DWY2DATE(1,Week + 1,Year));
