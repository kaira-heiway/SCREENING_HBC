report 51083 "ExpBankPaymDRC-BCDC-CDF CBN"
{
    // HEI.01 CHG2086827 IBM POENAB02 23.11. 2020 Bank Connectivity DRC  complementing BRD HT84
    //  # Object created.

    // BC Upgrade KUMARS145 Nav ID Report 50498 "ExpBankPaymDRC-BCDC-CDF CBN"

    Caption = 'Export Bank Payments - BCDC Bank CDF';
    ProcessingOnly = true;
