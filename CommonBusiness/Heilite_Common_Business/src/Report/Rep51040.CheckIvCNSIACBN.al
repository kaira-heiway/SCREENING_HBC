report 51040 "Check IvC NSIA CBN"
{
    ...
    // BC Upgrade KUMARS145 Nav ID Report 50285 "Check IvC NSIA"

    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Check IvC NSIA.rdl';
    Caption = 'Check IvC NSIA';
    ...
    begin
        ...
        /*GenJnlLine3.Reset();
        GenJnlLine3.SetRange("Journal Template Name",'PAYMENTS');
        GenJnlLine3.SetRange("Journal Batch Name",'EM-BICI I');
