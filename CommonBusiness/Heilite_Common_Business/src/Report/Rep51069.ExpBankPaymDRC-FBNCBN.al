report 51069 "Exp Bank Paym DRC FBN CBN"
{
    // version NAVFR7.10.00.36366,IBM 1001

    // HEI.01 FDD-HT521 IBM BULIMC01 28.04.2020 #new report created for exporting a .txt file for FBN bank payments
    ...
    // HEI.03 CHG2086827 IBM POENAB02 23.11. 2020 Bank Connectivity DRC  complementing BRD HT84
    //  # Modified functions WriteGnlJnlLineToFile, SetGenJnlLine

    // BC Upgrade KUMARS145 Nav ID Report 50437 "Exp Bank Paym DRC FBN CBN"

    Caption = 'Export Bank Payments - FBN Bank';
    ProcessingOnly = true;
