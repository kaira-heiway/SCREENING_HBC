report 51073 "Exp Bank Paym DRC BCDC CBN"
{
    // version NAVFR7.10.00.36366,IBM 1001

    // HEI.01 FDD-HT521 IBM BULIMC01 28.04.2020 #new report created for exporting a .txt file for BCDC bank payments
    ...
    // BC Upgrade KUMARS145 Nav ID Report 50441 "Exp Bank Paym DRC BCDC CBN"

    Caption = 'Export Bank Payments - BCDC Bank';
    ProcessingOnly = true;
