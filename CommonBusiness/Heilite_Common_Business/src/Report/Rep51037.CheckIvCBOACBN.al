report 51037 "Check IvC BOA CBN"
{
    ...
    // BC Upgrade KUMARS145 Nav ID Report 50282 "Check IvC BOA"

    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Check IvC BOA.rdl';
    Caption = 'Check IvC BOA';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            begin
                ...
                MntLettres2 := CopyStr(MntLettres, FindLastSpace(CopyStr(MntLettres, 1, 55)) + 2);
                MntLettres := CopyStr(MntLettres, 1, FindLastSpace(CopyStr(MntLettres, 1, 55)));
