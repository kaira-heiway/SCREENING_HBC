report 51038 "Check IvC CITI CBN"
{
    ...
    // BC Upgrade KUMARS145 Nav ID Report 50283 - Check IvC CITI

    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Check IvC CITI.rdl';
    Caption = 'Check IvC CITI';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    begin
                        if not TestPrint then begin
                            // with GenJnlLine do begin // BC upgrade KUMARS145 Removed 'with' statement as it is deprecated. // BC upgrade KUMARS145 Removed 'with' statement as it is deprecated.
                            CheckLedgEntry.Init();
    ...
    begin
        ...
        if Evaluate(LineNo2, VoidGenJnlLine.GetFilter("Line No.")) then;
