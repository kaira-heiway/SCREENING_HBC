report 51053 "Proforma Invoice Burundi CBN"
{
    // version HEI.01
    ...
    DefaultLayout = RDLC;
    //RDLCLayout = '.\src\Proforma Invoice Burundi.rdl';//BC UPGRADE PATHAA02
    RDLCLayout = '.\src\Reportslayout\Proforma Invoice Burundi.rdl';//BC UPGRADE PATHAA02  
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    // column(SalesHOrdNo; "Sales Header"."Order No.")//BC UPGRADE PATHAA02-DIT(F2014093)
                    // {
                    // }
            ...
            begin
                ...
                //BC UPGRADE PATHAA02-DIT(F2013726)-code commented>>
    ...
    begin
        ...
        if "Sales Header"."Document Subtype Code FND" in [DocSubtypeCodeSetup."Sundry Sales Order Non Stock", DocSubtypeCodeSetup."Sundry Sales Order Stock"] then
            ExportInvoice := false
        else begin
