report 51042 "Detail Trial Balance LR CBN"
{
    // version NAVFR7.10,DITW17.00.01,IBM 1001,HEI.01

    // DITW16.00.00.41 AHU 16/08/2012 DIT-715 #327 Added 'DataItemLink' property dataitem "G/L Entry"
    // DITW17.10.02 DDR 22/11/2013 DIT-770 #000 Upgrade R2
    // HNK100021 MRA-IBM 12/07/15: New report
    // 
    // HEI.01 FDD-HT520 IBM.GUNERE01 26.08.2019
    //   # Report imported from HeiLite 2.0

    //Bc Upgrade YADAVM09 Code blocked due to dependency on Drink it field.
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Detail Trial Balance LR.rdl';
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem(Date; Date)
            {
                ...
                begin
                    ...
                    //   CurrReport.CREATETOTALS("G/L Entry"."Debit Amount", "G/L Entry"."Credit Amount"); //BCUPG CREATETOTALS DEPRECATED //PANDEA04
                end;
            }
            ...
            begin
                ...
                //     "G/L Entry"."Debit Amount", "G/L Entry"."Credit Amount"); //BCUPG CREATETOTALS DEPRECATED //PANDEA04
