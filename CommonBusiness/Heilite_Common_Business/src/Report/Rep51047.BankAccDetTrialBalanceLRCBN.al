report 51047 "BankAccDetTrialBal LR CBN"
{
    // version NAVFR7.10,IBM 1001,HEI.01

    // HNK100041 MRA-IBM 21/07/15: New report based on the standard French localization report 10803
    // 
    ...
    RDLCLayout = '.\src\ReportsLayout\Bank Acc Det Trial Balance LR.rdl';
        ...
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            dataitem(Date; Date)
            {
                ...
                begin
                    ...
                    // CurrReport.CREATETOTALS("Bank Account Ledger Entry"."Debit Amount (LCY)", "Bank Account Ledger Entry"."Credit Amount (LCY)"); //BCUPG CREATETOTALS DEPRECATED //PANDEA04
                end;
            }
            ...
            begin
                ...
                // CurrReport.CREATETOTALS("Debit Amount (LCY)", "Credit Amount (LCY)");//BCUPG CREATETOTALS DEPRECATED //PANDEA04
