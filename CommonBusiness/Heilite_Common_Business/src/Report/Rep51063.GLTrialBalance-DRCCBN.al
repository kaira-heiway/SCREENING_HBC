report 51063 "G/L Trial Balance DRC CBN"
{
    // version NAVFR7.10,IBM 1001,HEI.01

    // HEI.01 FDD-HT1146 IBM SURYAS01 20/04/2020
    // #Created New Report "G/L Trail Balance - DRC"
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\GL Trial Balance - DRC.rdl';
    ...
    var
        ...
        HeinekenBCUpgrade: Codeunit "Heineken BC Upgrade";  // BC Upgrade Priya
        ImprNonMvt: Boolean;
        EndDate: Date;
        PreviousEndDate: Date;
        PreviousStartDate: Date;
        StartDate: Date;
        TLAccountType: Enum "G/L Account Type";
        TextDate: Text[30];
        "Filter": Text[250];
