report 51021 "Realized Receipts Export CBN"
{
    // version HEI.01
    ...
    // 3. Auto-generate filename with year and week
    // 4. Added ApplicationArea and UsageCategory properties to all fields
    ...
    // 8. Comment Drink IT Fields Related Code
    ...
    requestpage
    {
        ...
        begin
            ...
            if Filename = '' then
                Filename := 'RealizedReceipt_' + Format(Year) + '_W' + Format(Week) + '.txt';
            // BC Upgrade BHARDA11 <<
        end;
    }
