report 51044 "Cust Detail Trial Bal LR CBN"
{
    // version NAVFR7.10,DITW17.10.03,IBM 1001,HEI.01

    // DITW16.00.00.41 AHU 16/08/2012 DIT-715 #327 Added 'DataItemLink' property dataitem "Cust. Ledger Entry"
    // DITW16.00.00.42 DDR 30/11/2012 DIT-715 #370 Added to filter on "Item Charge Type Filter","Service Contract No. Filter"
    ...
    // HNK100047 MRA-IBM 23/07/15: New report based on the French localization report 10806 with the added modifications of DIT from standard NAV report 104
    // FDD-HNK 100128 NaikH01 12/02/2016 : #Added New DataItem "Cust. Ledger Entry" and new Column "Document Date".
    ...
    // BC Upgrade BHARDA11 <<
    DefaultLayout = RDLC;
    RDLCLayout = '.\src\ReportsLayout\Cust. Detail Trial Balance LR.rdl';
    ApplicationArea = All;
