page 51025 "Rejected PO Invoices CBN"
{
    // version HEI.01
    ...
    // #Created new page for Payment Status Rejected filter and Doc subtype code-PO

    // BC Upgrade PATELS08 >>
    // # Added Usage Category Property at page level.
    // # Changed group name 'Navigation' to 'NavigationGroup', as 'Navigation' is area type, this will cause error in future.
    // BC Upgrade PATELS08 <<

    Caption = 'Rejected PO Invoices';
    ...
    // BC Upgrade PATELS08 >> # Added Usage Category Property at page level.
    UsageCategory = Lists;
    // BC Upgrade PATELS08 <<
    ...
    SourceTableView = sorting("Posting Date")
                      ...
                      where("Payment Status FND" = FILTER("Payment Rejected"),
                            "Document Subtype Code FND" = CONST('PO'));
    //BC Upgrade VAMSIU01 <<
    ...
    actions
    {
        ...
        area(processing)
        {
            // BC Upgrade PATELS08 >> # Changed group name 'Navigation', as 'Navigation' is area type, this will cause error in future.
            // group(Navigation)
