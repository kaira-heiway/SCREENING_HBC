page 51060 "PO Prepayment Request List CBN"
{
    ...
    //   # HEI.03 Code blocked on trigger OnNewRecord() and OnOpenPage() because dependency on DrinkIT field "Document Subtype Code".

    // DrinkIT code and fields are blocked

    // BC Upgrade SHUKLP03 >> "Document Subtype Code" code added on trigger OnNewRecord() and OnOpenPage().

    Caption = 'PO Prepayment Request';
    CardPageID = "PO Prepayment Request CBN";
    ...
    ApplicationArea = ALL; // BC Upgrade SHUKLP03 <<
                           // UsageCategory = Lists; // BC Upgrade SHUKLP03 << // BC Upgrade BHARAD11 
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                // BC Upgrade SHUKLP03 >> DrinkIT fields are blocked.
                // field("Sundry Vendor";"Sundry Vendor")
                // {
                //     Editable = false;
                //     Visible = false;
                // }
    ...
    actions
    {
        area(navigation)
        {
            group("O&rder")
            {
                ...
                // BC Upgrade SHUKLP03 >> Action blocked because dependancy on DrinkIT Page "Document Shipping Cost".
        ...
        area(processing)
        {
            ...
            group("&Print")
            {
                ...
                // BC Upgrade SHUKLP03 >> Actions blocked because depandency on DrinkIT code.
                // action("&Order")
                // {
                //     Caption = '&Order';
                //     Image = Print;
