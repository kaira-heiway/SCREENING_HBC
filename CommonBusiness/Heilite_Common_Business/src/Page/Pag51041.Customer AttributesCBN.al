page 51041 "Customer Attributes CBN"
{
    // version HEI.01

    // HEI.01 Bugfixing Bahamas IBM NASTAA02 12.12.2018 # Customer Attributes
    //   # New Page created for Customer Attributes
    // HEI.02 FDD-HT587 IBM BULIMC01 #CardPageID property changed

    Caption = 'Customer Attributes';
    CardPageID = "Customer Attributes Card CBN";
    PageType = List;
