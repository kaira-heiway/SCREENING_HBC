pageextension 51207 PurchCrMemoSubformExtCBN extends "Purch. Cr. Memo Subform"
{
    ...
    // HEI.04 HT1292 IBM SHANKJ03 04.27.2020
    //   # Field added "WHT Absorb Base"
    // HEI.05 CHG2090912 HB1641 IBM NANDIS01 01.02.2021 General Ledger Entries Description
    //   # Make visible of new field - "Additional Description"
    // HEI.06 CHG2111706 IBM GUNERE01 26.05.2021 # CheckAllowChangeDim func. created, Shortcut Dim code 1 - 2 onvalidate trigger
    //                                             modified
    // HEI.06 FDD-HT2159 - CHG2105031 IBM NASTAA02 21.07.2021 # VAT Centime - Part 2 - Purchases
    //   # New Field added: "CAD Amount"
    //   # Code added on 'OnOpenPage' trigger
    // HEI.07 CHG2217161 SAHAL01 09.11.2023 SPL for Returns and GR cancellations
    ...
    //1.Call CheckAllowChangeDim() function on validate of dimension shortcut fields to restrict changing dimensions when there are already transactions.
    //BC UPGRADE ATHUKS01 STP_FDD007<<
    ...
    layout
    {
        ...
        //     begin
        //         //HEI.02>>
        //         //Rec.UpdatePaymentStatus(Rec);//Bc Upgrade YADAVM09 Drink function code.
        //         //HEI.02<<
        //     end;
        // }
        modify("No.")
        ...
        */ //Bc Upgrade YADAVM09 <<
        ...
        modify("Location Code")
        {
            ...
            //Unsupported feature: Change Visible on ""Location Code"(Control 60)". Please convert manually.
        }
        modify("Bin Code")
        {
            ApplicationArea = all;
        ...
        modify("Shortcut Dimension 1 Code")
        {
            ...
            trigger OnAfterValidate()
            begin
                CheckAllowChangeDim; //BC UPGRADE ATHUKS01 STP_FDD007
            end;
        }
        ...
        */
        ...
        //Unsupported feature: CodeInsertion on ""Allow Invoice Disc."(Control 50)". Please convert manually.
        ...
        */
        ...
        //Unsupported feature: CodeInsertion on ""Inv. Discount Amount"(Control 80)". Please convert manually.
        ...
        */
        ...
        //Unsupported feature: CodeInsertion on ""Shortcut Dimension 1 Code"(Control 64)". Please convert manually.

        //trigger OnValidate();
        //Parameters and return type have not been exported.
        //begin
        /*
        CheckAllowChangeDim; //HEI.06
        */
        //end;


        //Unsupported feature: CodeInsertion on ""Shortcut Dimension 2 Code"(Control 62)". Please convert manually.
        ...
        */ //Bc Upgrade YADAVM09 Drink it field commented<<
        ...
        /* //Bc Upgrade YADAVM09 Field is already there in the base>>
        addafter(Nonstock)
        {
          ...
          */ //Bc Upgrade YADAVM09 Field is already there in the base<<
             /* //Bc Upgrade  Drink it code YADAVM09>>
        ...
        addafter("Total VAT Amount")
        {
            field(TotalCADAmount; CADTotalAmount)//BC Upgrade SHARMP16 CAD
            {
                ...
                //CaptionClass = DocumentTotals.GetTotalCADCaption(TotalPurchaseHeader."Currency Code");//Bc Upgrade YADAVM09
        ...
        addafter("Total Amount Incl. VAT")
        {
            ...
            {
                AutoFormatExpression = TotalPurchaseHeader."Currency Code";
                //CaptionClass = DocumentTotals.GetTotalInclCADCaption(PurchHeader."Currency Code");//BC UPgrade YADAVM09
    ...
    actions
    {
        modify(InsertExtTexts)
        {
            ...
            ToolTipML = ENU = 'Insert an extended description for the document.', FRA = 'Insérez une description plus longue pour le document.';
        }
        modify(Dimensions)
        {
        ...
        modify(DeferralSchedule)
        {
            ...
            ToolTipML = ENU = 'View or edit the deferral schedule that governs how expenses paid with this purchase document are deferred to different accounting periods when the document is posted.', FRA = 'Affichez ou modifiez le tableau d''échelonnement qui régit la manière dont les dépenses réalisées à l''aide de ce document achat sont échelonnées sur différentes périodes de comptabilité lorsque le document est validé.';
        }
        modify("F&unctions")
        {
        ...
        */ //Bc Upgrade YADAVM09 Drink it Action commented<<
        ...
        // addafter("Item &Tracking Lines")//Bc Upgrade YADAVM09 Drink it Action commented>>
        // {
    ...
    var
        ...
        DimErr: Label 'Dimension changes are not allowed in PO Credit Memos';
    ...
    */
    ...
    begin
        //HEI.02>>
        //  rec.UpdatePaymentStatus(Rec);//Bc Upgrade YADAVM09 Depnendency on Drink it field
        //HEI.02<<
...
*/ //Bc Upgrade YADAVM09 Drink it Function<<
    ...
    */ //Bc Upgrade YADAVM09 Drink it field<<
    ...
    // BC Upgrade VAMSIU01  - Document Subtype code added >>
    ...
    begin
        ...
        if (Rec."Document Type" = Rec."Document Type"::"Credit Memo") and (PurchSetup."PO Subtype Code FND" = PurchaseHeader."Document Subtype Code FND") and
           not Rec."Manual Insert FND"
        then
            ERROR(DimErr);
        //HEI.06<<
    end;
    ...
    //Unsupported feature: PropertyChange. Please convert manually.
    var
        BCHNKCustomFunction: Codeunit "Heineken BC Custom Functions";//BC Upgrade SHARMP16 CAD
