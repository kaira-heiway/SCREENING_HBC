pageextension 51051 FixedAssetJournalExtCBN extends "Fixed Asset Journal"
{
    ...
    layout
    {
        ...
        {
            ToolTipML = ENU = 'Represents the estimated residual value of a fixed asset when it can no longer be used.', FRA = 'Représente la valeur résiduelle estimée d''une immobilisation qui est devenue inutilisable.';
        }
    ...
    actions
    {
        ...
        modify("&Test Report")
        {
            ...
            ToolTipML = ENU = 'Preview the resulting fixed asset entries to see the consequences before you perform the actual posting.', FRA = 'Affichez les écritures comptables immobilisation résultantes pour voir les conséquences avant d''effectuer la validation effective.';
        }
        modify(Post)
        {
        ...
        //Unsupported feature: CodeModification on "Post(Action 50).OnAction". Please convert manually.
