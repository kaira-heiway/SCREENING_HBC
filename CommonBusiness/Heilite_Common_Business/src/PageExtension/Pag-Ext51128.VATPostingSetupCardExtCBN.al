pageextension 51128 VATPostingSetupCardExtCBN extends "VAT Posting Setup Card"
{
    ...
    // HEI.01 FDD-HB1609 CHG2074002 IBM BULIMC01 26.08.2020 #new field added:"Free Goods VAT(HNK)"
    ...
    layout
    {
        ...
        {
            ToolTipML = ENU = 'Specifies if documents that use this combination of VAT business posting group and VAT product posting group require a certificate of supply.', FRA = 'Spécifie si des documents qui utilisent cette combinaison de groupe comptabilisation marché TVA et de groupe comptabilisation produit TVA nécessitent un certificat d''approvisionnement.';
        }
        modify("Tax Category")
        {
        ...
        {
            ToolTipML = ENU = 'Specifies the general ledger account number to which to post unrealized sales VAT (as calculated when you post sales invoices) using this particular combination of VAT business posting group and VAT product posting group.', FRA = 'Spécifie le numéro du grand livre sur lequel vous souhaitez enregistrer la TVA ventes prévue (comme elle est calculée lorsque vous validez des factures vente) avec cette combinaison particulière de groupe comptabilisation marché TVA et de groupe comptabilisation produit TVA.';
        }
        modify(Purchases)
        {
        ...
        {
            ToolTipML = ENU = 'Specifies the general ledger account number to which to post unrealized purchase VAT (as calculated when you post purchase invoices) using this particular combination of VAT business posting group and VAT product posting group.', FRA = 'Spécifie le numéro du compte général sur lequel vous souhaitez enregistrer la TVA achats prévue (comme elle est calculée lorsque vous validez des factures achat) avec cette combinaison particulière de groupe comptabilisation marché TVA et de groupe comptabilisation produit TVA.';
        }
        ...
        {
            ToolTipML = ENU = 'Specifies the general ledger account number to which you want to post amounts for unrealized reverse charge VAT (purchase VAT) for this combination of VAT business posting group and VAT product posting group, if you have selected the Reverse Charge VAT option in the VAT Calculation Type field.', FRA = 'Spécifie le numéro du compte général sur lequel vous souhaitez valider des montants pour la TVA déductible prévue (TVA achats) pour cette combinaison de groupe comptabilisation marché TVA et de groupe comptabilisation produit TVA, si vous avez sélectionné l''option Déductible dans le champ Mode calcul TVA.';
        }
        addafter("VAT %")
        {
        ...
        addafter("Tax Category")
        {
            ...
            field("CAD %"; Rec."CAD % FND")
            {
                ...
                begin
                    //HEI.02>>
                    if Rec."CAD % FND" = 0 then
                        if Rec."Sales CAD Account FND" <> '' then
                            Rec."Sales CAD Account FND" := '';
                    //HEI.02<<
                end;
            }
        }
        addafter("Sales VAT Unreal. Account")
        {
            ...
            {
                Editable = Rec."CAD % FND" > 0;
                Visible = EnableCAD;
                ApplicationArea = All;
                ToolTip = 'Specifies the value of the Sales CAD Account field.';
            }
        }
        addafter("Reverse Chrg. VAT Unreal. Acc.")
        {
