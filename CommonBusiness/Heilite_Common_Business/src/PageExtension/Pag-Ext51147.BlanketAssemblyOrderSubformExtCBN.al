pageextension 51147 BlanketAsmblyOrdSubformExtCBN extends "Blanket Assembly Order Subform"
{
    ...
    layout
    {
        ...
        {
            ToolTipML = ENU = 'Specifies how many units of the assembly component you want to post as consumed when you post the assembly order.', FRA = 'Indique le nombre d''unités du composant d''assemblage que vous souhaitez valider comme consommées lors de la validation de la ligne d''ordre d''assemblage.';
        }
        modify("Consumed Quantity")
        {
            ToolTipML = ENU = 'Specifies how many units of the assembly component have been posted as consumed during the assembly.', FRA = 'Indique le nombre d''unités du composant d''assemblage qui ont été validées comme consommées durant l''assemblage.';
        }
        modify("Remaining Quantity")
        {
            ToolTipML = ENU = 'Specifies how many units of the assembly component remain to be consumed during assembly.', FRA = 'Spécifie le nombre d''unités du composant d''assemblage restant à consommer durant l''assemblage.';
        }
        modify("Qty. Picked")
        {
            ToolTipML = ENU = 'Specifies how many units of the assembly component have been moved or picked for the assembly order line.', FRA = 'Spécifie le nombre d''unités du composant d''assemblage ayant été prélevées ou déplacées pour la ligne d''ordre d''assemblage.';
        }
        modify("Pick Qty.")
        {
            ToolTipML = ENU = 'Specifies how many units of the assembly component are currently on warehouse pick lines.', FRA = 'Spécifie le nombre d''unités du composant d''assemblage qui sont actuellement dans les lignes prélèvement entrepôt.';
        }
        modify("Due Date")
        {
        ...
        {
            ToolTipML = ENU = 'Specifies how many units of the assembly component have been reserved for this assembly order line.', FRA = 'Spécifie le nombre d''unités du composant d''assemblage ayant été réservés pour cette ligne d''ordre d''assemblage.';
        }
        ...
        {
            ToolTipML = ENU = 'Specifies the number of a particular item ledger entry that the assembly order line is applied to.', FRA = 'Spécifie le numéro d''une écriture comptable article particulière à laquelle la ligne d''ordre d''assemblage est appliquée.';
        }
        modify("Appl.-from Item Entry")
        {
            ToolTipML = ENU = 'Specifies the number of the item ledger entry that the assembly order line is applied from.', FRA = 'Spécifie le numéro de l''écriture comptable article à laquelle la ligne d''ordre d''assemblage est appliquée.';
        }
